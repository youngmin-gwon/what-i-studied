...
tags: [android, compose, internal, ui, view]
aliases: [Jetpack Compose Internals, Measure Layout Draw, View System]
...
안드로이드 UI 의 역사는 2010 년의 `View.java`(2 만 줄)에서 2020 년의 `@Composable` 로 완전히 바뀌었습니다.
