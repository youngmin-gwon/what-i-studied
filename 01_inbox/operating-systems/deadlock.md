---
title: deadlock
tags: [concurrency, deadlock, operating-systems, synchronization]
aliases: [Banker's Algorithm, Deadlock Prevention, 교착상태, 데드락]
date modified: 2026-01-08 15:56:16 +09:00
...
교착상태가 발생하려면 **4 가지 조건이 모두 동시에** 만족해야 합니다.
...
**4 대 조건 중 하나를 부정**하여 발생을 원천 차단합니다.
...
Dijkstra 가 고안한 교착상태 회피 알고리즘입니다.
