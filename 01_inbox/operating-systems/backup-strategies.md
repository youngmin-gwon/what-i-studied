---
title: Backup Strategies (백업 전략)
tags: [operating-systems, backup, disaster-recovery, storage]
aliases: [백업, Full Backup, Incremental, Differential]
...
| **복구 시간** | **빠름** | 김 | 중간 |
| **저장 공간** | 많음 | **적음** | 중간 |
| **복구 필요 세트** | 1개 | Full + 모든 Inc | **Full + 마지막 Diff** |
...
- [[raid-technologies]] - RAID를 통한 데이터 보호
- [[lvm]] - 논리 볼륨과 스냅샷 백업
