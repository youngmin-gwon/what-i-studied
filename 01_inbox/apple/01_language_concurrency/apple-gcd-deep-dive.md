...
Swift Concurrency 가 나왔지만, **GCD(libdispatch)** 는 여전히 Apple 플랫폼 동시성의 **기반(Foundation)** 입니다.

레거시 코드를 이해하거나, Swift Concurrency 가 제공하지 않는 **세밀한 제어** 가 필요할 때 GCD 지식은 필수입니다.
...
네트워크 요청이 한 번에 3 개까지만 나가도록 제한하고 싶을 때 유용합니다.
