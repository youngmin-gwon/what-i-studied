...
aliases: []
date modified: 2026-04-03 18:52:02 +09:00
...
4. **버전 체계의 변화 (iOS 26+)**:
   - 2025년, Apple은 모든 OS 버전을 출시 연도와 맞추는 **대점프(Version Jump)**를 단행했습니다. 이에 따라 iOS 19 다음 버전은 **iOS 26**이 되었으며, 모든 플랫폼(macOS, watchOS 등)이 동일한 메인 버전 번호를 공유합니다.
