...
date modified: 2025-12-19 16:18:28 +09:00
...
- **int 자료형 기준**: 1MB $\approx$ 약 25 만 개의 정수 저장 가능.
- **안전선**: 보통 128MB~512MB 제한 환경에서 **5,000 만 개 이하**의 공간을 할당한다면 OOM(메모리 초과) 위험에서 안전합니다.
...
>[!IMPORTANT] **한 줄 정리**
> - **연산 횟수 1 억 번 이하** $\rightarrow$ 시간 초과 가능성 매우 낮음.
> - **공간 할당 5,000 만 개 이하** $\rightarrow$ 메모리 초과 가능성 매우 낮음.
