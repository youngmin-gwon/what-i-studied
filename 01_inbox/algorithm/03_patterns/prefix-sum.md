...
## 📚 관련 문서
- [[03_patterns/two-pointers|투 포인터]] - 가변 구간 탐색 및 슬라이딩 윈도우와의 차이점
- [[00_fundamentals/complexity-and-big-o|복잡도 분석]] - $O(N)$ 전처리 후 $O(1)$ 조회의 성능 이점
- [[01_data-structures/linear|배열과 리스트]] - 연속된 메모리 공간에서의 구간 데이터 처리
- [[02_algorithms/dynamic-programming|동적 계획법]] - 누적 합을 활용한 상태 전이 식 설계
- [[01_data-structures/segment-tree|세그먼트 트리]] - 데이터 업데이트가 잦은 환경에서의 구간 합 대안
