...
### 📚 연결 문서
- [[04_math/math-modular-and-exponentiation|수학]] - 빠른 거듭제곱도 비트를 쪼개서 계산함
- [[02_algorithms/backtracking|백트래킹]] - 모든 부분집합을 구할 때 비트 마스크가 더 빠름
- [[01_data-structures/hash-and-map|Hash Map]] - 집합의 메모리 효율적 대안
- [[00_fundamentals/complexity-and-big-o|복잡도]] - 비트 연산은 모두 $O(1)$
