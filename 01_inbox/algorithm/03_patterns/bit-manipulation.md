...
- [수학적 기초](../04_math/math-modular-and-exponentiation.md) - 비트 분할을 활용한 빠른 거듭제곱 알고리즘
- [백트래킹](../02_algorithms/backtracking.md) - 모든 부분집합 생성 시 비트 마스크 활용 최적화
- [해시와 맵](../01_data-structures/hash-and-map.md) - 공간 효율성이 극대화된 비트셋(Bitset)의 대안
- [복잡도 분석](../00_fundamentals/complexity-and-big-o.md) - 상수 시간($O(1)$)에 실행되는 비트 연산의 특징
- [선형 자료구조](../01_data-structures/linear.md) - 비트 수준에서의 데이터 저장 및 처리 원리
