...
tags: [algorithm, dynamic-programming, greedy, optimization, pattern]
aliases: [그리디, 동적 계획법, 최적화 알고리즘]
date modified: 2025-12-18 10:05:58 +09:00
date created: 2025-12-17 19:50:00 +09:00
---

## Optimization: 컴퓨터를 효율적으로 부려먹기

같은 문제를 풀어도 누군가는 1 시간 (Exponential) 이 걸리고, 누군가는 1 초 (Linear/Polynomial) 가 걸립니다.
...
>DP 는 알고리즘 문제에만 나오는 게 아닙니다. **웹 브라우저 캐시, CDN, 데이터베이스 쿼리 캐시** 모두 "한 번 한 일은 저장해둔다"는 DP 의 철학을 따릅니다.
...
거스름돈 문제 (10, 50, 100, 500 원) 처럼 큰 단위가 작은 단위의 배수일 때 등, 특수한 수학적 조건에서만 "항상 최적해"를 보장합니다.
...
- [[algo-ds-hash-and-map]] - Memoization 을 위한 저장소
