...
## 📚 관련 문서
- [[02_algorithms/dynamic-programming|동적 계획법]] - 중복 계산을 제거하는 최적화의 핵심 기법
- [[03_patterns/two-pointers|투 포인터]] - $O(N^2)$ 문제를 $O(N)$으로 변환하는 대표적 최적화 패턴
- [[00_fundamentals/complexity-and-big-o|복잡도 분석]] - 최적화의 대상을 선별하기 위한 성능 척도 이해
- [[00_fundamentals/problem-solving-process|문제 해결 프로세스]] - 설계 단계에서의 알고리즘 선택 가이드
- [[02_algorithms/greedy|그리디 알고리즘]] - 국소적 최적해를 통한 빠른 문제 해결 전략
