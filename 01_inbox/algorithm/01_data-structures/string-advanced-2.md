...
## 📚 관련 문서
- [[01_data-structures/string-advanced|고급 문자열 I]] - Trie 와 KMP 기초
- [[01_data-structures/tree-and-graph|트리와 그래프]] - 아호 - 코라식의 기반이 되는 Trie 구조
- [[00_fundamentals/complexity-and-big-o|복잡도 분석]] - $O(N + M + K)$ 아호 - 코라식의 선형 시간 효율성
- [[02_algorithms/search-and-sort|검색과 정렬]] - 접미사 배열에서의 이진 탐색 활용
