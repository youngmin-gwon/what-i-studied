...
tags: [algorithm, data-structure, linear, stack, queue, lifo, fifo]
aliases: [스택, 큐, Stack, Queue, LIFO, FIFO]
date modified: 2025-12-18 12:04:02 +09:00
...
- **OS 스케줄링**: Ready Queue에 대기 중인 프로세스를 순서대로 할당.
