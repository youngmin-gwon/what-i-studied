...
최소 신장 트리(MST)를 찾는 그리디의 대표격입니다. [[01_data-structures/disjoint-set|Union-Find]]를 활용하여 효율적으로 구현합니다.
...
3. **우선순위 큐 미활용**
   - 데이터가 동적으로 추가되면서 매번 최솟값/최댓값을 찾아야 한다면 단순 정렬보다 [[01_data-structures/heap-and-priority-queue|Heap]]이 훨씬 빠릅니다.
