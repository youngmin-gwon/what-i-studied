...
tags: [certification, index, overview, security, 정보보안기사]
aliases: [Security Overview, 보안 인덱스, 정보보안기사 개요]
date modified: 2026-01-13 00:05:23 +09:00
...
| 주제                              | 문서                                                                           |
| ------------------------------- | ---------------------------------------------------------------------------- |
| 운영체제 역사 (MS-DOS, Windows, Unix) | [operating-system-history](../operating-systems/operating-system-history.md) |
| 커널과 쉘 구조                        | [kernel-structure](../operating-systems/kernel-structure.md)                 |
| Run Level (실행 레벨)               | [run-levels](../linux/run-levels.md)                                         |

### 운영체제 보안

| 주제                  | 문서                                                    |
| ------------------- | ----------------------------------------------------- |
| Windows 보안          | [windows-client-security](windows-client-security.md) |
...
- [ ] 1 장: 시스템 보안 (OS, 악성코드)
- [ ] 2 장: 네트워크 보안 (프로토콜, 공격, 솔루션)
- [ ] 3 장: 애플리케이션 보안 (웹, 전자상거래)
- [ ] 4 장: 정보보안 일반 (암호학, 인증)
- [ ] 5 장: 관리 및 법규 (ISMS, 법률)
