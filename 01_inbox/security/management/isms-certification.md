...
tags: [certification, isms, isms-p, iso27001, kisa, security]
aliases: [ISMS, ISMS-P, ISO 27001, 인증, 정보보호 관리체계]
...
ISMS 는 **지속적 개선**을 위해 PDCA 순환 주기를 따릅니다.
...
「정보통신망법」 제 47 조 제 2 항에 따른 의무 대상:

| 대상 | 기준 |
|------|------|
| **ISP** | 서울/광역시에서 서비스 제공 |
| **IDC** | 집적정보통신시설 사업자 |
| **상급종합병원** | 매출액 1,500 억 원 이상 |
| **매출액** | 정보통신서비스 100 억 원 이상 |
| **이용자 수** | 일평균 100 만 명 이상 (직전 3 개월) |
...
>**ISMS 만 필요한 경우**: 개인정보 처리 22 개 제외 → **80 개 기준**
...
| 조건 | 기준 |
|------|------|
| 신규 시스템 | 정보주체 **5 만 명** 이상 |
| 연동 시스템 | 정보주체 **50 만 명** 이상 |
...
| 인증 | 대상 | 유효기간 | 특징 |
|------|------|:--------:|------|
| **ISO 27001** | 글로벌 | 3 년 | 국제 표준 |
| **ISMS-P** | 국내 | 3 년 | 정보보호 + 개인정보 통합 |
| **CSAP** | 클라우드 (공공) | 3 년 | IaaS/SaaS/DaaS |
