...
1. **Functionality-as-Tool**: 앱의 핵심 기능을 AI 에이전트가 호출할 수 있는 '도구' 형태로 설계하십시오. ([**android-appfunctions-and-ai-agents**](../android/04_system_services/assistant-agent/appfunctions-capabilities.md), [apple-intelligence-and-agentic-intents](../apple/04_system_services/apple-intelligence-and-agentic-intents.md))
2. **Adaptive Interaction**: 고정된 화면이 아닌 창 모드(Windowing)와 공간(XR) 환경에 최적화된 레이아웃을 구축하십시오. ([**android-xr-and-spatial-computing**](../android/07_platforms/xr/xr.md), [apple-spatial-computing-visionos](../apple/07_platforms/apple-spatial-computing-visionos.md))
