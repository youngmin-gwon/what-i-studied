...
2. **Adaptive Interaction**: 고정된 화면이 아닌 창 모드(Windowing)와 공간(XR) 환경에 최적화된 레이아웃을 구축하십시오. ([**android-xr-and-spatial-computing**](../android/07_platforms/xr/xr.md), [apple-spatial-computing-visionos](../apple/07_platforms/apple-visionos-system.md))
