...
tags: [security, incident-response, mobile, case-study]
aliases: []
date modified: 2026-04-05 20:10:00 +09:00
...
최근 2년간 발생한 주요 모바일 보안 침해 사고 사례분석과 공격 유형별 실무 대응 가이드입니다. 
...
- **특징**: 제조 단계에서 펌웨어에 심어지거나, 서드파티 SDK의 취약점을 통해 금융 정보를 탈취합니다.
- **대응**:
...
- [[cross-platform-mobile-vulnerability-check]] - 보안 진단 체크리스트
