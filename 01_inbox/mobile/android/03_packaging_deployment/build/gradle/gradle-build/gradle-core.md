...
date modified: 2026-08-19 11:00:29 +09:00
...
flowchart TD
    ...
    Engine --> Lifecycle["실행 생명주기 (Lifecycle)<br/>(Init ➔ Config ➔ Exec & Config Cache)"]
    Engine --> TaskAPI["Task 모델 & Provider API<br/>(Lazy Task, Property/Provider, Worker API)"]
    Engine --> Optimization["빌드 캐시 & 최적화<br/>(UP-TO-DATE, Local/Remote Build Cache)"]
```
