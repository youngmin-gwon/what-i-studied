---
title: gradle-core
tags: ["gradle", "build-engine", "build-automation", "jvm"]
aliases: ["Gradle 코어", "Gradle 코어 엔진", "Gradle 아키텍처", "Gradle Core Engine"]
...
### Gradle 코어 아키텍처의 4대 핵심 기둥

#### 1. [실행 생명주기 (Execution Lifecycle)](gradle-lifecycle.md)
Gradle 은 빌드 요청 시 3단계 생명주기를 엄격히 분리하여 실행한다.
