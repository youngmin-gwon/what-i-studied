...
11. [Android Gradle Plugin (AGP) 아키텍처 및 확장 모델](android-gradle-plugin.md)
12. [AGP defaultConfig 및 앱 식별자·버전 명세](agp-default-config.md)
13. [AGP Build Variant 아키텍처 및 변형 매트릭스](agp-build-variants.md)
14. [AGP SourceSet 우선순위 및 리소스·코드 병합 규칙](agp-source-sets.md)
15. [AGP 서명 설정 및 키 관리](agp-signing-config.md)
16. [AGP 릴리스 빌드 점검 체크리스트](agp-release-checklist.md)
