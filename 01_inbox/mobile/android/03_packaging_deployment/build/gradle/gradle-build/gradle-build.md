...
aliases: ["Gradle 빌드 시스템", "Gradle 빌드 아키텍처", "Gradle Build System"]
date created: 2026-07-31 17:52:17 +09:00
date modified: 2026-08-20 18:10:00 +09:00
---
...
Gradle은 범용 빌드 자동화 엔진이며, Android 앱을 빌드하기 위해서는 **AGP(Android Gradle Plugin)** 가 제공하는 도메인 특화 태스크와 DSL(Domain Specific Language) 명세가 결합되어야 한다.
...
6. [Gradle Task 모델 및 Provider API](gradle-task-api.md)
7. [Gradle 캐싱 및 빌드 최적화](gradle-caching-and-optimization.md)
8. [Gradle 플러그인 및 모듈화 아키텍처](gradle-plugins.md)
9. [Gradle 의존성 구성 및 클래스패스 격리](gradle-dependency-configurations.md)
10. [Android Gradle Plugin (AGP) 아키텍처 및 확장 모델](android-gradle-plugin.md)
11. [Android 기본 설정은 식별자와 버전 명세를 정의한다](android-default-config-defines-identity-and-version.md)
12. [Build type, product flavor, build variant는 서로 다른 축이다](build-type-product-flavor-and-build-variant-are-different-axes.md)
