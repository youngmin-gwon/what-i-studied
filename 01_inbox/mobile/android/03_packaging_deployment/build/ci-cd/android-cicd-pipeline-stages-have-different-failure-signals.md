...
관련 노트: [Android CI/CD 게이트는 빠른 검증과 릴리스 검증을 분리한다](../dependency-versioning/dependency-ci/android-cicd-gates-separate-fast-validation-and-release-validation.md), [Android CI/CD](ci-cd.md)
