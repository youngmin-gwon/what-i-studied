---
title: ci-credentials-security
tags: ["android", "ci-cd", "security", "signing"]
aliases: ["CI 서명과 서비스 계정 자격증명은 소스 제어에 남아선 안 된다"]
date modified: 2026-08-31 19:01:11 +09:00
...
이러한 파일이나 비밀번호가 실수로 Git 소스 제어 레포지토리에 커밋되어 노출되면, 악의적인 공격자가 기존 앱을 위조하고 탈취하여 해킹된 APK 를 유포할 수 있다.
...
관련 노트: [AGP 서명 설정 및 키 관리](../gradle/agp-signing-config.md), [Android CI/CD](ci-cd.md)
