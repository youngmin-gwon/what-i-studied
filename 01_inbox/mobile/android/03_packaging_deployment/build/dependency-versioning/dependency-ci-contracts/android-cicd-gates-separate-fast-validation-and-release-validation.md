...
관련 노트: [Android CI/CD 파이프라인 단계는 서로 다른 실패 시그널을 가진다](../../ci-cd/android-cicd-pipeline-stages-have-different-failure-signals.md), [의존성 및 CI 계약](dependency-ci-contracts.md)
