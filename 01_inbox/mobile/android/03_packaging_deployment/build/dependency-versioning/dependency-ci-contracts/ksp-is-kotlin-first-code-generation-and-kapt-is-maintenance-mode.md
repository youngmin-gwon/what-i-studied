...
관련 노트: [kotlinx.serialization은 컴파일러 플러그인과 런타임 포맷이 모두 필요하다](kotlinx-serialization-requires-compiler-plugin-and-runtime-format.md), [의존성 및 CI 계약](dependency-ci-contracts.md)
