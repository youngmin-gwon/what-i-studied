...
관련 노트: [Compose compiler는 BOM이 아니라 Kotlin 컴파일러 흐름에 속한다](compose-compiler-belongs-to-kotlin-compiler-flow-not-bom.md), [의존성 및 CI 계약](dependency-ci-contracts.md)
