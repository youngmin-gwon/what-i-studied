...
관련 노트: [증분 빌드, 빌드 캐시, configuration 캐시는 빌드 작업을 줄인다](incremental-build-cache-and-configuration-cache-reduce-build-work.md), [빌드 최적화 계약](build-optimization-contracts.md)
