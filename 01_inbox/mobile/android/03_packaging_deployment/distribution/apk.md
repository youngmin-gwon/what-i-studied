...
- [Play app signing은 업로드 키와 앱 서명 키를 분리한다](release/play-app-signing.md) - Google Play 표준 맞춤형 앱 분할 배포 아티팩트
- [D8과 R8 컴파일러 및 덱싱(Dexing) 메커니즘](../optimization/d8-and-r8.md) - D8/R8 을 통한 바이트코드 덱싱 및 최적화
