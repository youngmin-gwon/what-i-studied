...
date modified: 2026-08-31 19:02:14 +09:00
date created: 2026-07-31 17:52:17 +09:00
created: 2026-07-31 17:52:17 +09:00
updated: 2026-08-05 16:15:00 +09:00
---

## On-demand 및 conditional delivery 는 설치 상태와 실패 UX 를 요구한다
...
1. **`SplitInstallStateUpdatedListener` 상태 기계**:
   - `PENDING` $\rightarrow$ `DOWNLOADING` $\rightarrow$ `INSTALLING` $\rightarrow$ `INSTALLED` 상태 변경을 추적하고 프로그레스 바 UI 를 갱신함.
