...
tags: ["android", "play-delivery", "testing", "fake-split-install"]
...
2. **Internal App Sharing 검증**: AAB를 올리고 실제 디바이스에서 동적 모듈 다운로드 시 프로그레스 바 UI 및 네트워크 승인 팝업 동작을 수초 만에 정밀 검증함.
...
관련 노트: [On-demand 및 conditional delivery는 설치 상태와 실패 UX를 요구한다](on-demand-and-conditional-delivery-require-install-state-and-failure-ux.md), [Play Delivery 계약](play-delivery-contracts.md)
