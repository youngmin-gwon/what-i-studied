...
관련 노트: [Delivery mode는 필요성, 조건, 그리고 런타임 요청으로 선택된다](delivery-mode-is-selected-by-necessity-condition-and-runtime-request.md), [Play Delivery 계약](play-delivery-contracts.md)
