---
title: in-app-review-api
tags: ["android", "in-app-review", "play-core", "ux"]
...
## In-app review API 는 리뷰를 요청할 뿐 보장하지 않는다
...
Google Play 는 과도한 리뷰 팝업 남발로 인한 사용자 경험 저해를 막기 위해 엄격한 쿼터(Quota)와 내부 쿨다운 알고리즘을 적용하기 때문이다.
...
관련 노트: [In-app update의 flexible과 immediate 흐름은 블로킹에서 차이가 난다](in-app-update-flows.md), [릴리스 배포 계약](release-distribution.md)
