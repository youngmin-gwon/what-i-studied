---
title: staged-rollout-operations
tags: ["android", "google-play", "release", "staged-rollout"]
aliases: ["Staged rollout은 관측 가능한 배포 작업이다"]
date modified: 2026-08-31 19:02:29 +09:00
date created: 2026-07-31 17:52:17 +09:00
created: 2026-07-31 17:52:17 +09:00
updated: 2026-08-05 16:15:00 +09:00
---

## Staged rollout 은 관측 가능한 배포 작업이다
...
3. **Rollout Promotion**: 이상 지표가 없으면 비율을 $20\% \rightarrow 50\% \rightarrow 100\%$ 로 단계별 클릭 또는 Fastlane API 를 통해 높여 배포를 완료함.
...
현재 단계적 롤아웃의 반영 비율 및 진행 상태는 Fastlane 또는 Play Console API 로 확인할 수 있다:

```bash
bundle exec fastlane run google_play_track_version_codes package_name:"com.example.myapp" track:"production"
```

관련 노트: [Play release 체크리스트는 아티팩트, 서명, 트랙, 롤백 조건을 동결한다](play-release-checklist.md), [릴리스 배포 계약](release-distribution.md)
