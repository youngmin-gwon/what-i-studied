...
관련 노트: [In-app update의 flexible과 immediate 흐름은 블로킹에서 차이가 난다](in-app-update-flexible-and-immediate-flows-differ-in-blocking.md), [릴리스 배포 계약](release-distribution.md)
