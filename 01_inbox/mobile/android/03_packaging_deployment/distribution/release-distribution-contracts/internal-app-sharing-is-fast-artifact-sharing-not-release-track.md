...
관련 노트: [Google Play 테스트 트랙은 타깃 청중과 피드백 범위를 분리한다](google-play-testing-tracks-split-audience-and-feedback-scope.md), [릴리스 배포 계약](release-distribution-contracts.md)
