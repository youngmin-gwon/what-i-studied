...
7. **[Google Play Billing 계약](distribution/billing/billing.md)**: 2026-08-06 기준 최신 Play Billing Library 9.1.0, 상품·지역·등록 프로그램별 결제 경로 판정, 서버 측 Purchase Token 검증, 구매 완료 후 3 일 이내 Acknowledge/Consume, 구독 라이프사이클. 라이브러리 버전과 정책은 출시 시점에 다시 확인한다.
