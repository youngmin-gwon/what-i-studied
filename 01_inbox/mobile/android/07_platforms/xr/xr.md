...
- [SceneCore는 3D entity와 공간 환경을 다루는 계층이다](scenecore-3d-environments.md)
- [XR 앱은 공간 capability를 실행 중에 확인해야 한다](xr-spatial-capability-checks.md)
- [XR 입력은 gaze, hand, controller, keyboard를 함께 설계한다](xr-multimodal-input-gaze-hands.md)
- [XR 품질은 성능, 편안함, 안전을 기능 요구사항으로 포함한다](xr-comfort-safety-performance.md)
- [XR 출시 준비는 기능 시연이 아니라 기기, fallback, 정책 검증이다](xr-release-readiness-validation.md)
