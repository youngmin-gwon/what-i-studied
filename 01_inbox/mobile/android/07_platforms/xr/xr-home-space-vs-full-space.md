...
관련 지도: [Android XR 계약](./xr-contracts/xr-contracts.md)

개념 노트: [Android XR은 평면 앱 포트가 아니라 공간 폼 팩터다](./xr-contracts/android-xr-is-spatial-form-factor-not-flat-port.md)
...
- [Android XR은 평면 앱 포트가 아니라 공간 폼 팩터다](./xr-contracts/android-xr-is-spatial-form-factor-not-flat-port.md)
- [Android XR 계약](./xr-contracts/xr-contracts.md)
