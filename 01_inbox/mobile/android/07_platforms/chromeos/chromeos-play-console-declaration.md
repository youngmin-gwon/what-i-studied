---
title: chromeos-play-console-declaration
...
- 이 노트는 배포 심사와 기기 카탈로그 조건을 다룬다. 실행 환경 자체의 창 매핑 방식은 [ChromeOS는 Android 앱을 컨테이너에서 실행하고 창을 데스크톱 윈도우로 매핑한다](chromeos-container-window-mapping.md) 가 다룬다.
