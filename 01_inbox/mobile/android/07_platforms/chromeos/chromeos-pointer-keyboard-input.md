---
title: chromeos-pointer-keyboard-input
...
- 이 노트는 입력 우선순위 차이를 다룬다. 창 크기/레이아웃 적응은 `07_platforms/large-screens/large-screen-contracts` 가, 실행 환경 자체는 [ChromeOS는 Android 앱을 컨테이너에서 실행하고 창을 데스크톱 윈도우로 매핑한다](chromeos-container-window-mapping.md) 가 다룬다.
