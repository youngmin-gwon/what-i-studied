...
1. [Android TV는 d-pad/리모컨을 1차 입력으로 가정한다](android-tv-dpad-input.md) 에서 터치가 없는 입력 모델을 본다.
2. [10-foot UI는 포커스 기반 탐색을 요구한다](10-foot-ui-focus-navigation.md) 에서 레이아웃과 포커스 이동 설계를 본다.
3. [Android TV 배포는 터치스크린 미보유를 명시적으로 선언해야 한다](android-tv-no-touchscreen-declaration.md) 에서 Play 콘솔 배포 조건을 본다.
...
- [Android TV는 d-pad/리모컨을 1차 입력으로 가정한다](android-tv-dpad-input.md)
- [10-foot UI는 포커스 기반 탐색을 요구한다](10-foot-ui-focus-navigation.md)
- [Android TV 배포는 터치스크린 미보유를 명시적으로 선언해야 한다](android-tv-no-touchscreen-declaration.md)
