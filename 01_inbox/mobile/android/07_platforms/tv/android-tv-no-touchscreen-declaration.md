---
title: android-tv-no-touchscreen-declaration
...
- 이 노트는 Play 배포 조건을 다룬다. 실제 UI 가 d-pad 로 조작 가능한지는 [Android TV는 d-pad/리모컨을 1차 입력으로 가정한다](android-tv-dpad-input.md) 와 [10-foot UI는 포커스 기반 탐색을 요구한다](10-foot-ui-focus-navigation.md) 가 다룬다.
