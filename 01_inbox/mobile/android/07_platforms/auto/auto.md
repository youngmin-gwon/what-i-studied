...
1. [Android Auto는 투영이고 Android Automotive OS는 차량에 내장된 독립 OS다](android-auto-vs-automotive-os.md) 에서 두 플랫폼을 혼동하지 않는 법을 본다.
2. [Car App Library는 운전 중 배포 콘텐츠를 제한된 템플릿으로만 허용한다](car-app-library-templates.md) 에서 자유 레이아웃이 금지되는 이유를 본다.
3. [Android Automotive는 Car HAL을 통해 차량 신호에 접근한다](automotive-car-hal-signals.md) 에서 속도/기어 같은 차량 데이터 접근 경로를 본다.
...
- [Android Auto는 투영이고 Android Automotive OS는 차량에 내장된 독립 OS다](android-auto-vs-automotive-os.md)
- [Car App Library는 운전 중 배포 콘텐츠를 제한된 템플릿으로만 허용한다](car-app-library-templates.md)
- [Android Automotive는 Car HAL을 통해 차량 신호에 접근한다](automotive-car-hal-signals.md)
