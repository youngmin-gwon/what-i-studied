---
title: car-app-library-templates
...
- 이 노트는 화면 구성 제약을 다룬다. 두 플랫폼(투영형/내장형)의 근본적 차이는 [Android Auto는 투영이고 Android Automotive OS는 차량에 내장된 독립 OS다](android-auto-vs-automotive-os.md) 가 다룬다.
