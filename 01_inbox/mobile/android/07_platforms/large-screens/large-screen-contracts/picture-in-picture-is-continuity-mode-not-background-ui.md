---
title: picture-in-picture-is-continuity-mode-not-background-ui
...
- [데스크톱 윈도잉에서는 앱 창이 자유롭게 변한다](../windowing-multitasking-contracts/desktop-windowing-makes-android-app-window-freeform.md)
