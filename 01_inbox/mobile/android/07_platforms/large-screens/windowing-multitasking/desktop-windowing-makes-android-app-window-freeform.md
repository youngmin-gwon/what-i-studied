...
- [창 크기 클래스는 기기 종류가 아니라 앱 창을 분류한다](../large-screens/window-size-class-classifies-app-window-not-device-type.md)
- [키보드, 포인터, 스타일러스는 큰 화면의 기본 입력이다](../large-screens/keyboard-pointer-and-stylus-are-primary-large-screen-inputs.md)
