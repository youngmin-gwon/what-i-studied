...
| [navigation](navigation/navigation.md) | `navigation/navigation/navigation.md` | Manifest/Intent 로 OS 가 컴포넌트를 찾는 계약, deep link 검증, Navigation 3 back stack, adaptive navigation |
| [app-widgets](app-widgets/app-widget.md) | `app-widgets/app-widget/app-widget.md` | `AppWidgetProvider` lifecycle, `RemoteViews` 제약, 위젯 설정 Activity, `updatePeriodMillis` best-effort 스케줄 |
