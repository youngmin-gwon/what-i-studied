...
관련 계약: [SceneStrategy는 entry를 조합하고 decorator는 렌더링을 감싼다](scene-strategy-composes-entries-while-decorator-wraps-rendering.md)
...
- 연관 계약: [SceneStrategy는 entry를 조합하고 decorator는 렌더링을 감싼다](scene-strategy-composes-entries-while-decorator-wraps-rendering.md)
