---
title: scene-strategy-decorators
...
관련 계약: [Metadata와 SceneStrategy는 표시 정책을 전달한다](metadata-scene-strategy.md)
...
- 연관 계약: [Metadata와 SceneStrategy는 표시 정책을 전달한다](metadata-scene-strategy.md)
