...
- [Intent 입력은 명시적인 타입과 신뢰 경계가 필요하다](01_inbox/mobile/android/02_app_framework/navigation/intents-and-deep-links/intent-manifest-contracts/intent-inputs-need-explicit-type-and-trust-boundaries.md)
...
- [외부 URI는 navigation 전에 검증한다](01_inbox/mobile/android/02_app_framework/navigation/intents-and-deep-links/deep-link-contracts/external-uri-must-be-validated-before-navigation.md)
...
- [Navigation 3 route key는 안정적인 직렬화 식별자다](01_inbox/mobile/android/02_app_framework/navigation/navigation3/navigation3-contracts/route-key-should-be-stable-and-serializable.md)
