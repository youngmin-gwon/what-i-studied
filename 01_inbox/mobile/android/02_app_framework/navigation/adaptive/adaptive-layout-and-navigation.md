...
3. **Scaffold 수신 및 UI [재구성](../../jetpack-compose/runtime/recomposition.md)**:
...
- [Adaptive Navigation 계약](adaptive-layout-and-navigation.md)
- [Adaptive navigation은 device type이 아니라 현재 window와 posture로 결정한다](adaptive-window-posture.md)
- [Top-level destination은 adaptive navigation chrome의 단위다](top-level-navigation-chrome.md)
- [표준 adaptive scaffold를 먼저 검토하고 custom layout은 명시적 이유가 있을 때 둔다](standard-adaptive-scaffolds.md)
- [Pane layout은 선택 상태와 back policy를 분리해 보존해야 한다](pane-layout-selection-back-policy.md)
- [Navigation 3 Scene과 adaptive scaffold는 서로 다른 레이아웃 문제를 푼다](navigation3-scenes-vs-adaptive-scaffolds.md)
...
- [Large Screen Contracts](../../../07_platforms/large-screens/large-screen.md)
...
- 관련 아키텍처: [Navigation 3 계약](../navigation3/navigation3.md)
