---
title: standard-adaptive-scaffolds
...
관련 계약: [Top-level destination은 adaptive navigation chrome의 단위다](top-level-navigation-chrome.md)
...
- 연관 계약: [Top-level destination은 adaptive navigation chrome의 단위다](top-level-navigation-chrome.md)
