...
- **[navigation3-scene-and-strategy](../navigation3/navigation3-scene-and-strategy.md)** 는 **"현재 이동 상태의 콘텐츠를 어떻게 배치할 것인가?" (Screen Content Layout)** 에 관한 반응형 틀이다. (Single-Pane ↔ List-Detail 2-Pane ↔ Supporting-Pane 3-Pane)
...
| 구분 | [NavigationSuiteScaffold](navigation-suite-scaffold.md) | [Navigation 3 Scene](../navigation3/navigation3-scene-and-strategy.md) |
| :--- | :--- | :--- |
...
- [navigation3-scene-and-strategy](../navigation3/navigation3-scene-and-strategy.md) - Navigation 3 Scene & Multi-Pane API
- [jetpack-navigation-3-guide](../navigation3/jetpack-navigation-3-guide.md) - Jetpack Navigation 3 가이드
- [adaptive-layout-and-navigation](adaptive-layout-and-navigation.md) - Compose Adaptive 가이드
