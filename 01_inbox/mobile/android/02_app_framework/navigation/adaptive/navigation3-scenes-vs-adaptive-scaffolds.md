---
title: navigation3-scenes-vs-adaptive-scaffolds
...
관련 계층: [Metadata와 SceneStrategy는 표시 정책을 전달한다](../navigation3/metadata-scene-strategy.md)
...
- 연관 계약: [Metadata와 SceneStrategy는 표시 정책을 전달한다](../navigation3/metadata-scene-strategy.md)
- 연관 계약: [NavDisplay와 entry provider는 렌더링과 route registry를 분리한다](../navigation3/navdisplay-entry-provider.md)
