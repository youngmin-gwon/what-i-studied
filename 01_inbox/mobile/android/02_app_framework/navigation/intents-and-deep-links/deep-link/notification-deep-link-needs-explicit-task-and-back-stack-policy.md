...
관련 계약: [PendingIntent는 위임된 미래 intent 토큰이다](../intent-manifest/pendingintent-is-delegated-future-intent-token.md)
...
- 연관 계약: [PendingIntent는 위임된 미래 intent 토큰이다](../intent-manifest/pendingintent-is-delegated-future-intent-token.md)
