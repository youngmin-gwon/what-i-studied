...
- [Deep link는 외부 URI 계약이다](deep-link-is-external-uri.md)
...
- 연관 아키텍처: [Navigation 3 deep link는 URI를 NavKey로 변환한다](../../navigation3/navigation3/navigation3-deep-link-converts-uri-to-navkey.md)
