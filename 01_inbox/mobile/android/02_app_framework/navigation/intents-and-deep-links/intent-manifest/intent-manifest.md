...
- [Intent filter는 컴포넌트의 수신 계약이다](intent-filter-is-component-receiving.md)
...
- [Activity Result API는 수명주기를 인식하는 결과 계약을 정의한다](activity-result-api-defines-lifecycle-aware-result.md)
