---
title: assetlinks-verification-json
...
관련 계약: [App Link는 검증된 https deep link다](app-links-verification.md)
...
- 연관 계약: [App Link는 검증된 https deep link다](app-links-verification.md)
