---
title: notification-deep-link-back-stack
...
관련 계약: [PendingIntent는 위임된 미래 intent 토큰이다](pendingintent-tokens.md)
...
- 연관 계약: [PendingIntent는 위임된 미래 intent 토큰이다](pendingintent-tokens.md)
