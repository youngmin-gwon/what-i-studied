---
title: architecture-decision-criteria
...
- **소유자 수명 (Owner Lifetime)**:
  ...
  - **[viewmodel](../state-management/viewmodel.md) Lifetime**: 화면 회전(Configuration Change)을 넘어서 살아남는 UI 관산자 수명.
...
- 관련 계약 문서:
  ...
  - [SavedStateHandle은 프로세스 데스의 소량 상태를 복구한다](../state-management/savedstatehandle-state-restoration.md)
