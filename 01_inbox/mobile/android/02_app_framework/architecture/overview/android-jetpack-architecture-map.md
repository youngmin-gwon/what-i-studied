...
- [Jetpack Architecture는 필수 stack이 아니라 책임 분리 지도다](jetpack-responsibility-map.md)
- [아키텍처 결정은 owner, lifetime, survival 요구에서 시작한다](architecture-decision-criteria.md)
- [UI, domain, data layer는 rendering, policy, source of truth를 분리한다](layer-separation-principles.md)
- [Jetpack Architecture 문서는 세부 구현을 반복하지 않는 map이어야 한다](architecture-guide-links.md)
...
4. **Navigation & Multiplatform**:
   - [Navigation 3 Contracts](../../navigation/navigation3/navigation3.md)
