...
현대 안드로이드 OS 가 발전함에 따라, 무분별한 백그라운드 실행으로 인한 배터리와 메모리 고갈을 막기 위해 **단순 백그라운드 서비스는 완전 엄금**되었으며, 현대 안드로이드 개발에서는 **[Foreground Service](../../../04_system_services/background-and-notifications/background-work/foreground-service.md)** 와 **[WorkManager](../../../04_system_services/background-and-notifications/background-work/work-manager.md)** 로 명확히 대체 분리되었다.
...
- **Service (보이지 않는 주방 안의 조리사)**:
  - 홀(Activity UI)에는 보이지 않지만 주방 안(백그라운드)에서 요리를 계속 만드는 조리사. 현대에는 손님에게 지속 알림 깃발([Foreground Service](../../../04_system_services/background-and-notifications/background-work/foreground-service.md))을 꽂고 일하거나, 예약형 자동 요리 기계([WorkManager](../../../04_system_services/background-and-notifications/background-work/work-manager.md))에게 일을 넘겨야만 요리가 허용됨.
...
3. **[WorkManager](../../../04_system_services/background-and-notifications/background-work/work-manager.md) 대체**:
...
- [Foreground Service 계약](../../../04_system_services/background-and-notifications/background-work/foreground-service.md) - 지속 알림 기반 FGS 런타임 규약
- [WorkManager 예약 작업](../../../04_system_services/background-and-notifications/background-work/work-manager.md) - 백그라운드 작업 현대 대체 수단
