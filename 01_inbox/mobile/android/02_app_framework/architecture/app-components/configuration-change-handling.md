---
title: configuration-change-handling
...
| [viewmodel](../state-management/viewmodel.md) | 같은 `ViewModelStore` 경계를 통해 유지 | 소실 |
...
관련 노트: [ViewModel 수명과 프로세스 데스 계약](../state-management/viewmodel-lifecycle-survival.md)
