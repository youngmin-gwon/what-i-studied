...
date modified: 2026-08-03 16:34:25 +09:00
...
원칙은 콜백을 짧게 유지하고 lifecycle 에 묶인 리소스만 다루는 것이다. 화면 상태는 ViewModel 과 saved state 로, 영속 데이터는 repository/storage 로, 지연 가능한 작업은 background work 로 보낸다.
