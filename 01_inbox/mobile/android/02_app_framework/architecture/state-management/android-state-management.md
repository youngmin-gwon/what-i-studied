...
4. [StateFlow는 현재값이 필요한 화면 상태에 사용하고 Flow는 원천 데이터 흐름에 사용한다](../../data/async-flow/flow-state/stateflow-is-for-current-screen-state-flow-is-for-source-stream.md)
5. [Composable과 함께 취소되어야 하는 작업은 LaunchedEffect로 시작한다](../../jetpack-compose/state-and-lifecycle/compose-state-and-effect/launched-effect.md)
...
- [Flow와 [stateflow](../../stateflow-and-sharedflow.md) 상태 계약](../../data/async-flow/flow-state/flow-state.md)
- [Compose 상태와 Effect 계약](../../jetpack-compose/state-and-lifecycle/compose-state-and-effect/compose-state-and-effect.md)
