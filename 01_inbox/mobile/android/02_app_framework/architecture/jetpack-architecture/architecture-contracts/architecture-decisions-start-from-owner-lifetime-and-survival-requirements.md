...
관련 노트: [state-management 정본](../../state-management/android-state-management.md), [프로세스 종료 복구](../../app-components/app-component-contracts/process-death-recovery-needs-saved-state-and-persistent-source-of-truth.md), [background work 정본](../../../../04_system_services/background-and-notifications/background-work-contracts/background-work-contracts.md).
