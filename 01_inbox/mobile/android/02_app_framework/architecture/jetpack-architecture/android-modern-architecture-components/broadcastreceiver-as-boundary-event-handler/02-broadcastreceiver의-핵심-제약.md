...
흡수된 이전 노트: `02_app_framework/architecture/jetpack-architecture/android-modern-architecture-components/broadcastreceiver-as-boundary-event-handler/02-broadcastreceiver의-핵심-제약.md`
