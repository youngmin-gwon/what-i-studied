---
title: component-context-boundaries
...
- 관련 계약 문서:
  - [BroadcastReceiver는 단명 이벤트 진입점이다](../app-components/broadcast-receiver-lifecycle.md)
  - [Service는 백그라운드/원격 작업 진입점이다](../app-components/service-execution-boundaries.md)
