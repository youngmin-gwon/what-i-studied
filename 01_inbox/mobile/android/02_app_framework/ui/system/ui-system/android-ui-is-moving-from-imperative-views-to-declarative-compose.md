...
Compose 의 runtime 관점은 [Automatic State Observation은 Compose와 Flutter rebuild 모델의 핵심 차이다](../../../jetpack-compose/runtime/compose-runtime/automatic-state-observation-is-the-compose-flutter-rebuild-difference.md) 와 연결된다.
