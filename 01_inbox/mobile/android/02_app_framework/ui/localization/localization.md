...
- [리소스 Qualifier는 런타임 로케일에 따라 문자열을 선택한다](locale-resource-qualifiers.md)
- [Android 13+ 앱별 언어 설정으로 setApplicationLocales가 시스템 로케일과 별개로 앱 언어를 바꾼다](per-app-language-preferences.md)
- [RTL 미러링은 start/end 속성에서는 자동이고 아이콘에서는 수동이다](rtl-layout-mirroring.md)
