...
- [Android UI는 imperative View에서 declarative Compose로 중심이 이동했다](imperative-views-vs-compose.md)
- [View System은 object tree를 변경하고 Compose는 state에서 UI를 재계산한다](view-tree-vs-compose-state.md)
- [RecyclerView와 LazyColumn은 같은 목록 문제를 푸는 다른 렌더링 계약이다](recyclerview-vs-lazycolumn.md)
- [Modern Android UI는 edge-to-edge, insets, back, adaptive layout을 함께 다룬다](edge-to-edge-insets.md)
