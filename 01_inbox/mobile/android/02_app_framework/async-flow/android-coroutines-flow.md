...
- [Flow와 StateFlow 상태 계약](flow-state/flow-state.md) - Repository stream 데이터 공급, ViewModel의 StateFlow 조합, UI Lifecycle-aware 수집 계약.
...
관련 지도: [Android Data Layer Map](../data/android-data-layer-map.md), [Android State Management](../architecture/state-management/android-state-management.md)
