...
aliases: []
date modified: 2026-08-03 18:09:35 +09:00
date created: 2026-08-03 16:59:23 +09:00
---

## Metro 는 get_it 식 전역 locator 가 아니라 compile-time Kotlin DI 로 이해한다

Flutter `get_it` 경험자는 DI 를 전역 registry 에서 객체를 꺼내는 방식으로 떠올리기 쉽다. Metro 는 Kotlin compiler plugin 기반의 compile-time DI 이므로, 핵심은 어디서든 꺼내 쓰는 것이 아니라 graph 가 생성자를 호출하고 binding 을 검증하게 두는 것이다.
