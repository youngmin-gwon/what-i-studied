...
aliases: [Version Catalog, toml, Compose BOM, kapt vs ksp]
---
...
BOM은 구글에서 테스트가 완료된 호환되는 라이브러리 세트를 제공합니다. 개별 버전을 일일이 명시할 필요가 없습니다.
...
- **KSP (Kotlin Symbol Processing)**: Kotlin 네이티브 지원으로 **최대 2배 이상 빠름**. 최신 라이브러리(Room, Hilt 등)는 KSP 사용이 필수적입니다.
