...
관련 노트: [cachedIn은 PagingData Flow를 ViewModel 수명에 묶는다](./cachedin-ties-pagingdata-flow-to-viewmodel-lifetime.md), [Flow와 StateFlow 상태 계약](../../async-flow/flow-state-contracts/flow-state-contracts.md)
