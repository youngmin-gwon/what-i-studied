---
title: remote-mediator-connects-network-pages-to-local-cache
...
관련 노트: [영속 저장소 계약](../../storage/persistence/persistence.md), [Room은 누적되고 조회되는 로컬 데이터를 저장한다](../../storage/persistence/room-stores-accumulated-queryable-local-data.md)
