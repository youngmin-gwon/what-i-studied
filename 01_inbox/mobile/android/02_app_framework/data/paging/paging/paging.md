...
- [cachedIn은 PagingData Flow를 [viewmodel](../../../viewmodel.md) 수명에 묶는다](./cachedin-ties-pagingdata-flow-to-viewmodel-lifetime.md)
...
- Flow 의 수집, 공유, `stateIn` 판단은 [Flow와 [stateflow](../../../stateflow-and-sharedflow.md) 상태 계약](../../async-flow/flow-state/flow-state.md) 로 둔다.
- Room/DataStore 와 durable source of truth 는 [영속 저장소 계약](../../storage/persistence/persistence.md) 로 둔다.
