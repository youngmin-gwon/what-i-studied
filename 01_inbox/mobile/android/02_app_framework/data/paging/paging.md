...
- [Hilt Dependency Injection](../../dependency-injection/hilt-di.md) - PagingSource 및 Repository의 의존성 주입 구조
- [Dagger DI Architecture](../../dependency-injection/dagger-di.md) - 커스텀 컴포넌트 기반 DI 구조
- [Push Notification & FCM](../../architecture/app-components/push-notification-and-fcm.md) - 실시간 메시징 수신 시 페이징 데이터 갱신 연동
