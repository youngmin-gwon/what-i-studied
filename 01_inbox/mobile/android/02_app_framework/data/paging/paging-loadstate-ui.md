...
관련 노트: [Android UI State](../../architecture/state-management/ui-state.md), [RemoteMediator는 network page와 local cache를 연결한다](remote-mediator-caching.md)
