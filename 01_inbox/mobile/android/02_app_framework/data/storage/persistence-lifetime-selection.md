---
title: persistence-lifetime-selection
...
| 데이터베이스 row 보다 큰 콘텐츠나 바이트(파일) | 파일 저장소 — 어떤 파일 API 를 쓸지는 [저장소 선택: 소유권과 공개 목적을 먼저 묻기](storage-selection-criteria.md)가 app-specific files/SAF/MediaStore/Photo Picker 로 다시 나눈다 |
