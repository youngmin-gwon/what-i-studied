...
- [Repository는 Flow를 노출하고 ViewModel은 화면 상태를 조합한다](../../../architecture/state-management/viewmodel/viewmodel.md)-composes-screen-state.md) - 단방향 데이터 흐름(UDF)과 레이어별 캡슐화 규칙.
