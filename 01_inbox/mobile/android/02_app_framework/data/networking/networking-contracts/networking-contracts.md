...
- coroutine 자체의 수명·취소·[구조적 동시성](../../../../../../computer-science/structured-concurrency.md) 모델은 [Coroutine 계약](../../async-flow/coroutines/coroutine-contracts.md) 에 둔다. 이 클러스터는 그 계약이 네트워크 호출에 어떻게 적용되는지만 다룬다.
