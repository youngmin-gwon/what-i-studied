...
관련 노트: [Structured concurrency는 부모 scope가 자식 작업의 수명을 소유하게 한다](../../async-flow/coroutines/structured-concurrency-parent-owns-child-lifetime.md), [Retrofit 인터페이스는 API 계약을 선언하고 OkHttp가 실제 전송을 담당한다](./retrofit-interface-declares-api-contract-while-okhttp-executes-transport.md)
