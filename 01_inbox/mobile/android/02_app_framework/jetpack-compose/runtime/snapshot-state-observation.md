---
title: snapshot-state-observation
...
관련 노트: [Recomposition은 전체 UI redraw가 아니라 필요한 Composable scope 재실행이다](./recomposition-scope-control.md), [Compose frame pipeline은 composition, layout, drawing으로 나뉜다](compose-frame-pipeline.md)
