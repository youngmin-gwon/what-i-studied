...
관련 노트: [Recomposition은 전체 UI redraw가 아니라 필요한 Composable scope 재실행이다](recomposition-scope-control.md), [Compose 상태와 Effect 계약](../state-and-effects/compose-state-and-effect.md)
