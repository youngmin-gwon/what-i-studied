---
title: composition-callsite-identity
...
관련 노트: [remember는 일반 cache가 아니라 Composition에 귀속된 저장공간이다](remember-storage-semantics.md), [@Composable 컴파일 결과는 restart와 skip 제어를 가능하게 한다](composable-compiler-restart-skip.md)
