---
title: automatic-state-observation
...
관련 노트: [Snapshot State 관찰은 State를 읽은 scope를 invalidation 대상으로 만든다](snapshot-state-observation.md), [Compose state owner는 읽고 쓰는 범위의 가장 낮은 공통 owner다](compose-state-ownership.md)
