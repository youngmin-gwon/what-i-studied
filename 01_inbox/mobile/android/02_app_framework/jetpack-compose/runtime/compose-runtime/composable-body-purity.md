...
- [LaunchedEffect 실행 규약](../../state-and-lifecycle/compose-state-and-effect/launched-effect.md) - 취소 가능한 부작용을 관리하는 LaunchedEffect
- [Composition 내 무거운 작업 처리 규약](../../performance/compose-performance/heavy-work-does-not-belong-in-composition.md) - Fast 규약 준수를 위한 성능 가이드
