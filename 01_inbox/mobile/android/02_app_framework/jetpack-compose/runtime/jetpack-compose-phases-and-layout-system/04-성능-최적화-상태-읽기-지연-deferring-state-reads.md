---
title: 04-성능-최적화-상태-읽기-지연-deferring-state-reads
...
흡수된 이전 노트: `02_app_framework/jetpack-compose/runtime/jetpack-compose-phases-and-layout-system/04-성능-최적화-상태-읽기-지연-deferring-state-reads.md`
