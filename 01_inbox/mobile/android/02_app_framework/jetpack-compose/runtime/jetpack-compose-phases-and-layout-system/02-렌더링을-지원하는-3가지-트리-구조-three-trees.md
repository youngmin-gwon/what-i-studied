---
title: 02-렌더링을-지원하는-3가지-트리-구조-three-trees
...
흡수된 이전 노트: `02_app_framework/jetpack-compose/runtime/jetpack-compose-phases-and-layout-system/02-렌더링을-지원하는-3가지-트리-구조-three-trees.md`
