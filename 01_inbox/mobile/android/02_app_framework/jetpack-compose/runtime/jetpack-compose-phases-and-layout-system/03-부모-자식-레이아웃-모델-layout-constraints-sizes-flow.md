---
title: 03-부모-자식-레이아웃-모델-layout-constraints-sizes-flow
...
흡수된 이전 노트: `02_app_framework/jetpack-compose/runtime/jetpack-compose-phases-and-layout-system/03-부모-자식-레이아웃-모델-layout-constraints-sizes-flow.md`
