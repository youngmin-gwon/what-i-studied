...
관련 노트: [AnimationSpec defines time physics and repeat policy](./animation-spec-defines-time-physics-and-repeat-policy.md), [Value animation APIs separate single target transition infinite and coroutine control](./value-animation-apis-separate-single-target-transition-infinite-and-coroutine-control.md)
