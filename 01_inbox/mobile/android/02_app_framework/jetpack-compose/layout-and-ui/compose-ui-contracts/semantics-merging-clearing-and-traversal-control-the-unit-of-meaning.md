...
date modified: 2026-08-03 18:10:32 +09:00
...
`clearAndSetSemantics` 는 기존 semantics 를 지우고 새 의미로 대체할 때 쓰며, 장식 요소를 접근성 서비스에서만 숨기는 `hideFromAccessibility` 와 다르다. 두 API 는 목적이 다르므로 "숨기기"로 뭉개면 안 된다.
