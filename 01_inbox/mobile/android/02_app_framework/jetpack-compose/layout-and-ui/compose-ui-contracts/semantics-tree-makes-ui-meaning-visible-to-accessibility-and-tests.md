...
관련 노트: [Semantics 병합·재정의·탐색 순서는 의미 단위를 조절한다](./semantics-merging-clearing-and-traversal-control-the-unit-of-meaning.md), [Testing quality contracts](../../../../06_testing_performance/testing/testing-quality-contracts/testing-quality-contracts.md)
