...
aliases: [size modifier, requiredSize, fillMaxSize]
...
`fillMax*`는 허용된 최대 크기를 채우도록 최소 제약까지 끌어올릴 수 있고, `wrapContentSize`는 child가 더 작게 측정될 수 있도록 제약을 완화한 뒤 남는 공간에서 배치를 조정한다.
