...
관련 노트: [Compose layout measures children under parent constraints](./compose-layout-measures-children-under-parent-constraints.md), [Intrinsic measurement and SubcomposeLayout solve special measurement problems](./intrinsic-measurement-and-subcompose-layout-solve-special-measurement-problems.md)
