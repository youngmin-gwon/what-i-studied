...
관련 노트: [Compose layout measures children under parent constraints](./compose-layout-measures-children-under-parent-constraints.md), [Size modifiers interpret requested size inside incoming constraints](./size-modifiers-interpret-requested-size-inside-incoming-constraints.md)
