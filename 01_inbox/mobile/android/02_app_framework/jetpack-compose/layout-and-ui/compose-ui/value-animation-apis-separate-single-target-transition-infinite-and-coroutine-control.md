...
관련 노트: [Compose animation API is selected by change unit and control level](./compose-animation-api-is-selected-by-change-unit-and-control-level.md), [AnimationSpec defines time physics and repeat policy](./animation-spec-defines-time-physics-and-repeat-policy.md)
