...
- [Glance는 Compose UI가 아니라 RemoteViews 위젯 경계로 렌더링한다](../../../app-widgets/app-widget/glance-renders-app-widgets-through-remoteviews-not-compose-ui.md) - App Widget 전용 클러스터([App Widget 계약](../../../app-widgets/app-widget/app-widget.md))로 이전했다.
