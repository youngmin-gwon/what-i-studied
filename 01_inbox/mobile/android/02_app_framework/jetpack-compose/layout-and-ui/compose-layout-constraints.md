---
title: compose-layout-constraints
...
관련 노트: [Modifier order changes layout draw and input wrappers](modifier-chain-order.md), [Size modifiers interpret requested size inside incoming constraints](size-modifiers-constraints.md)
