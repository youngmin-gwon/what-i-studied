---
title: 03-세분화된-모듈-레이어-및-의존성-아키텍처
...
흡수된 이전 노트: `02_app_framework/jetpack-compose/design-system-and-architecture/jetpack-compose-module-architecture/03-세분화된-모듈-레이어-및-의존성-아키텍처.md`
