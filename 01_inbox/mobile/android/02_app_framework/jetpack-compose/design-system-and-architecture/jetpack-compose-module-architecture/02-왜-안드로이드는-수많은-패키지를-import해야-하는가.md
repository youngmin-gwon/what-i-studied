---
title: 02-왜-안드로이드는-수많은-패키지를-import해야-하는가
...
흡수된 이전 노트: `02_app_framework/jetpack-compose/design-system-and-architecture/jetpack-compose-module-architecture/02-왜-안드로이드는-수많은-패키지를-import해야-하는가.md`
