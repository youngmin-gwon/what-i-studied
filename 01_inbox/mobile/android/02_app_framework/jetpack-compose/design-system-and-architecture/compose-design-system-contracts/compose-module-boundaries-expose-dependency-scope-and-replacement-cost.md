...
관련 노트: [Compose는 상위 컴포넌트가 맞지 않을 때 낮은 계층으로 내려갈 수 있게 설계됐다](./compose-layers-let-you-drop-down-when-higher-level-components-do-not-fit.md), [Gradle build contracts](../../../../03_packaging_deployment/build/gradle/gradle-build-contracts/gradle-build-contracts.md)
