...
관련 노트: [Material 3 Expressive 컴포넌트 크기와 토큰 선택](./m3-expressive-component-sizing-and-token-bundles.md), [Material 3 Expressive shape 스케일과 상호작용 shape 변형](./m3-expressive-shape-scale-and-interactive-shape-morphing.md), [Switch의 thumb 아이콘과 햅틱은 별도 계약이다](./m3-expressive-switch-specifies-thumb-morphing-check-icon-and-toggle-haptics.md)
