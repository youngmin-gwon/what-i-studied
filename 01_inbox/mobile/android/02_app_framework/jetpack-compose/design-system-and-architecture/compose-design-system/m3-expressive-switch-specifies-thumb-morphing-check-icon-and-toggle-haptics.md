...
관련 노트: [Material 3 Expressive 디자인 시스템 및 컴포넌트 아키텍처](./m3-expressive-design-system-and-component-architecture.md), [HapticFeedbackType은 UX 인터랙션을 플랫폼 햅틱 type에 매핑한다](../../../../04_system_services/device-capabilities/haptics-vibrator/haptic-feedback-types-map-ux-interactions-to-platform-patterns.md)
