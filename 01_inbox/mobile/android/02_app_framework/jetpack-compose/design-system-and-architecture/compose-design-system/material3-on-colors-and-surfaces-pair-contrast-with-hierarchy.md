...
관련 노트: [Material 3 색상 역할은 고정된 색상이 아닌 의미적 의도를 표현한다](./material3-color-roles-express-semantic-intent-not-fixed-colors.md), [접근성 품질은 서비스·검사기·Semantics 검증을 함께 요구한다](../../layout-and-ui/compose-ui/accessibility-quality-requires-service-scanner-and-semantics-verification.md)
