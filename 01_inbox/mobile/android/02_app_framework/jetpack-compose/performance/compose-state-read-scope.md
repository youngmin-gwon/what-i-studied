---
title: compose-state-read-scope
...
관련 노트: [Compose 성능 최적화는 측정·진단·개선 순환으로 진행한다](compose-performance-loop.md), [`derivedStateOf`는 고빈도 입력에서 저빈도 결과를 만들 때 쓴다](derived-state-of-optimization.md)
