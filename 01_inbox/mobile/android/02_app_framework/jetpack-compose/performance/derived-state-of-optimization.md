---
title: derived-state-of-optimization
...
관련 노트: [Compose 상태 읽기 위치는 다시 실행할 phase와 범위를 결정한다](compose-state-read-scope.md), [Compose 성능 최적화는 측정·진단·개선 순환으로 진행한다](compose-performance-loop.md)
