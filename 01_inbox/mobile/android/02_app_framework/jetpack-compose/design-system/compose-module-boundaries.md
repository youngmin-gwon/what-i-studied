---
title: compose-module-boundaries
...
관련 노트: [Compose는 상위 컴포넌트가 맞지 않을 때 낮은 계층으로 내려갈 수 있게 설계됐다](compose-layer-dropdown.md), [Gradle build contracts](../../../03_packaging_deployment/build/gradle/gradle-build.md)
