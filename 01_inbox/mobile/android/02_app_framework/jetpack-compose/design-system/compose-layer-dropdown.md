...
관련 노트: [Compose 모듈 경계는 의존성 범위와 교체 비용을 드러낸다](compose-module-boundaries.md), [Semantics Tree는 UI 의미를 접근성 서비스와 테스트에 드러낸다](../layout-and-ui/semantics-tree-accessibility.md)
