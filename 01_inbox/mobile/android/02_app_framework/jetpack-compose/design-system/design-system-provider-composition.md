---
title: design-system-provider-composition
...
관련 노트: [CompositionLocal은 트리 범위의 UI 환경 값을 암묵적으로 전달한다](compositionlocal-tree-scope.md), [Material 3 색상 역할은 고정된 색상이 아닌 의미적 의도를 표현한다](material3-color-roles.md)
