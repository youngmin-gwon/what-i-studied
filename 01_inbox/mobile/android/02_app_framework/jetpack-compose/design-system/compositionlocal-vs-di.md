...
관련 노트: [CompositionLocal은 트리 범위의 UI 환경 값을 암묵적으로 전달한다](compositionlocal-tree-scope.md), [Android dependency injection](../../dependency-injection/android-dependency-injection-map.md)
