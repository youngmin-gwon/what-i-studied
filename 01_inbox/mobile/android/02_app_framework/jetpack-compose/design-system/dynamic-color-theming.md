...
관련 노트: [Material 3 색상 역할은 고정된 색상이 아닌 의미적 의도를 표현한다](material3-color-roles.md), [Glance는 Compose UI가 아니라 RemoteViews 위젯 경계로 렌더링한다](../../app-widgets/glance-remoteviews-rendering.md)
