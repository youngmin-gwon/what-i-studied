...
관련 노트: [Design system provider는 MaterialTheme과 프로젝트 Local을 구성한다](design-system-provider-composition.md), [CompositionLocal은 트리 범위 UI 환경을 암묵적으로 전달한다](compositionlocal-tree-scope.md)
