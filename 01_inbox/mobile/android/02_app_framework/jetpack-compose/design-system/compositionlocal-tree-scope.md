---
title: compositionlocal-tree-scope
...
관련 노트: [CompositionLocal, 파라미터, DI는 서로 다른 문제를 푼다](compositionlocal-vs-di.md), [Design system provider는 Material theme과 프로젝트 Local을 함께 제공한다](design-system-provider-composition.md)
