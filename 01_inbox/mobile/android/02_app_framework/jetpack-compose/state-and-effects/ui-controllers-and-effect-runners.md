...
tags: [android, architecture, compose, effect-runners, lifetime, ui-controllers]
aliases: [UI Controllers & Effect Runners, UI 컨트롤러와 이펙트 러너 수명주기]
date modified: 2026-08-07 18:14:43 +09:00
...
3. **도메인 비즈니스 수명주기 분리**:
   - UI 렌더링 수명주기를 초과하여 생존해야 하는 비즈니스 데이터(SSOT)는 UI 계층이 아닌 [ViewModel](../../architecture/state-management/viewmodel.md) 스코프(`viewModelScope`)에 올바르게 격리 배치되어야 한다.
...
- [ViewModel](../../architecture/state-management/viewmodel.md) - 비즈니스 상태 홀더
