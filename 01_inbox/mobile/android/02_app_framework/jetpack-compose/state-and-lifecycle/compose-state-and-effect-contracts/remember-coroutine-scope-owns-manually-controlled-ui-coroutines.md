---
title: rememberCoroutineScope owns manually controlled UI coroutines
...
화면이 사라져도 완료되어야 하는 저장, 동기화, 결제, repository mutation을 이 scope에 숨기면 owner가 잘못된다. 그런 작업은 ViewModel이나 domain layer가 소유하고 UI는 event만 전달한다.
