...
스마트폰 사용 경험은 터치를 넘어 음성과 자동화로 확장되고 있습니다. App Actions는 앱의 기능을 시스템 수준의 역량(Capability)으로 노출하여 외부 진입점을 극대화합니다. [[android-deep-links]] 및 [[android-intent-and-ipc]] 아키텍처 위에서 동작하는 고급 통합 기술입니다.

> [!NOTE] **상호 참조**
> iOS의 Siri 및 App Intents 통합 방식은 [[apple-app-intents]]를 참고하세요.
