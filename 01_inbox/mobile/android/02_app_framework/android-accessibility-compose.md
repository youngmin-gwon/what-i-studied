...
단순히 시각적 UI를 구현하는 것을 넘어, 선언형 프레임워크인 Compose에서 접근성 정보를 어떻게 구조화하고 TalkBack 등의 보조 기술과 유기적으로 통신할지 이해하는 것이 목표입니다.
...
> [!NOTE] **상호 참조**
> iOS의 접근성 지원 방식은 [[apple-accessibility-and-internationalization]]을 참고하세요.
