...
- JNI reference 수명(local/global) 관리는 [JNI reference는 local, global, weak lifetime이 다르다](jni-references-have-local-global-and-weak-lifetimes.md)가 다룬다.
- native crash 디버깅 방법은 [Native 성능과 crash debugging은 경계 비용에서 시작한다](native-performance-and-crash-debugging-start-at-the-boundary.md)가 다룬다.
