...
실행 중 문제는 subsystem별 관찰점을 나눈다. memory pressure는 lmkd/PSI/oom_score_adj를 보고, power issue는 wakelock/SystemSuspend/wakeup source를 보며, SELinux issue는 `avc: denied`의 context/class/permission을 읽는다.
