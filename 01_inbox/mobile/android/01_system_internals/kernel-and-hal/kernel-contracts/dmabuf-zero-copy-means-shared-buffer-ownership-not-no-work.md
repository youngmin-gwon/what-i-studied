...
- BufferQueue에서의 producer/consumer 소유권 모델은 [BufferQueue는 producer와 consumer를 buffer ownership으로 분리한다](../../graphics-and-media/graphics-media-contracts/bufferqueue-separates-producer-and-consumer-with-buffer-ownership.md)가 다룬다.
...
- [BufferQueue는 producer와 consumer를 buffer ownership으로 분리한다](../../graphics-and-media/graphics-media-contracts/bufferqueue-separates-producer-and-consumer-with-buffer-ownership.md)
