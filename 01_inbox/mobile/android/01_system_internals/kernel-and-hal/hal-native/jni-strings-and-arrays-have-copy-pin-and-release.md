---
title: jni-strings-and-arrays-have-copy-pin-and-release
...
- [AndroidBitmap native 접근은 format, stride, lock lifetime을 확인해야 한다](androidbitmap-native-access-requires-format-stride-and-lock-lifetime.md)
- [JNI references have local global and weak lifetimes](jni-references-have-local-global-and-weak-lifetimes.md)
