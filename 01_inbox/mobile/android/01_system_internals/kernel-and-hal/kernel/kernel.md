...
- [Android kernel은 Linux에 모바일 플랫폼 정책을 더한 커널이다](android-kernel-is-linux-plus-mobile-platform-policy.md)
...
- [zRAM은 메모리 부족 해결책이 아니라 압축 swap 정책이다](zram-is-compressed-swap-policy-not-a-memory-fix.md)
...
- [eBPF는 검증된 프로그램으로 Android kernel 기능을 확장한다](ebpf-extends-android-kernel-through-verified-programs.md)
...
- [Kernel security는 AVB, dm-verity, SELinux, CFI가 나눠 맡는다](kernel-security-is-layered-with-avb-dmverity-selinux-and-cfi.md)
