...
- [Surface based media pipeline avoids app-level pixel copy](../../graphics-and-media/graphics-media/surface-based-media-pipeline-avoids-app-level-pixel-copy.md)
