---
title: wake-locks
tags: [android, battery, kernel, pm, power, system-internals, wake-locks]
aliases: [Wake Lock, WakeLocks, 웨이크 락, 전력 잠금]
date modified: 2026-08-07 13:28:47 +09:00
...
- **WakeLocks (건물 야간 경비원 깨움 버튼)**:
  - 야간에 건물의 불이 모두 꺼지고 경비원(CPU)이 수면(Deep Sleep)에 들어가려고 할 때, 백그라운드 작업자가 **"저 아직 야근 작업 중이니 1 시간만 자지 말고 깨어있어 주세요"** 하고 켜두는 타이머 경보 버튼.
...
- [Android Kernel 특화 구조](../android-kernel-runtime.md) - 안드로이드 커널 전력 관리
