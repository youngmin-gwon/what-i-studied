---
title: systemsuspend-and-wakelocks
...
- [Native system service는 init이 띄우고 Binder로 발견되는 endpoint다](../hal-native/native-system-services.md)
