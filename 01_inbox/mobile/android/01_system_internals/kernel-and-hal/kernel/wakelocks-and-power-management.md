...
- background 실행 제한 및 지속 작업 관리는 [Background restrictions require persistent work state](../../../04_system_services/background-and-notifications/background-restrictions-state.md)가 다룬다.
