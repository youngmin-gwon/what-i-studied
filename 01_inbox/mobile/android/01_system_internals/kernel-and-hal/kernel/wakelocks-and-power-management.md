---
title: wakelocks-and-power-management
...
- SystemSuspend HAL과 kernel suspend 중재 메커니즘은 [SystemSuspend는 userspace wakelock과 kernel suspend를 중재한다](systemsuspend-and-wakelocks.md)가 다룬다.
- background 실행 제한 및 지속 작업 관리는 [Background restrictions require persistent work state](../../../04_system_services/background-and-notifications/background-work/background-restrictions-state.md)가 다룬다.
