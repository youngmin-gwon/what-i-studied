...
관련 노트: {link(contracts_hub / "hardware-composer-offloads-composition-under-device-constraints.md", "Hardware Composer는 기기 제약 안에서 합성을 offload한다")}, {link(contracts_hub / "drm-protected-media-needs-secure-codec-and-output-path.md", "DRM 보호 미디어는 secure codec과 보호된 출력 경로를 요구할 수 있다")}
