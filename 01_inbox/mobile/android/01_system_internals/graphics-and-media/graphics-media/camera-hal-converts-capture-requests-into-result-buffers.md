...
- [카메라 출력 Surface는 프리뷰, 분석, 녹화 파이프라인을 정의한다](camera-output-surfaces-define-preview-analysis-and-recording-pipelines.md)
- [CameraX와 Camera2는 제어 경계가 다르다](camerax-and-camera2-have-different-control-boundaries.md)
