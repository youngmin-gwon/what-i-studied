---
title: anr-responsiveness-contract
...
date modified: 2026-08-07 13:44:38 +09:00
...
2. **Watchdog & Handler Message Queue Schedule**:
   - 컴포넌트 시작 시 [AMS](../../../04_system_services/service-lookup/activity-manager-service.md) 는 핸들러 메세지로 `SERVICE_TIMEOUT_MSG` 등을 스케줄링한다.
