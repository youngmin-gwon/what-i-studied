...
- ART 실행과 profile compilation은 runtime 비용 경계로 다루고 Gradle/R8 최적화와 섞지 않는다.
- copy-on-write 메모리 이점은 Zygote preload와 process private page 관점으로 설명한다.
