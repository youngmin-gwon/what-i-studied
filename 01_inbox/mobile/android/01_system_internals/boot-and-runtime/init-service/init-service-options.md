...
- [init-security-is-selinux-domain-and-capability-boundary](init-security-and-selinux.md)
- [init-service-is-supervised-process-with-explicit-lifecycle](init-service-lifecycle.md)
