---
title: boot-completion-milestones
...
3. **User Unlock 마일스톤 (`BOOT_COMPLETED`)**:
   ...
   - [AMS](../../../04_system_services/service-lookup/activity-manager-service.md)가 `Intent.ACTION_BOOT_COMPLETED` 브로드캐스트를 시스템 및 서드파티 앱에 디스패치한다.
...
- [system_server는 framework service를 한 프로세스 안에서 시작한다](../system-server/system-server-startup.md)
- [AMS는 앱 프로세스와 컴포넌트 lifecycle을 조율한다](../system-server/ams-app-process-lifecycle.md)
