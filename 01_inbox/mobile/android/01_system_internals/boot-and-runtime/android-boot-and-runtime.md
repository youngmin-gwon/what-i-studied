...
| **[system_server와 ActivityManager 계약](system-server/system-server.md)** | 프레임워크 서비스 단일 프로세스 호스팅, Binder Endpoint 제공, 앱 라이프사이클 및 ANR/OOM-Score 조율 | `SystemServer`, [AMS](../../04_system_services/activity-manager-service.md), ATMS, ServiceManager, Rescue Party | `dumpsys activity`, `dumpsys alarm`, `/data/anr/traces.txt` |
...
- [graphics-media](../graphics-and-media/graphics-media/graphics-media.md)
- [platform-modularity](../platform-modularity/platform-modularity/platform-modularity.md)
- [ipc-process](../ipc-and-process/ipc-process/ipc-process.md)
