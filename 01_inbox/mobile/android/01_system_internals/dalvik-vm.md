...
date modified: 2026-08-24 16:47:18 +09:00
...
3. **ART 로의 전환**:
   - 이러한 Dalvik 의 근본적인 한계를 해결하기 위해 Android 5.0 부터 앱 설치 시점에 미리 기계어로 번역하는 **AOT 컴파일**과 비차단 GC 를 탑재한 **[ART (Android Runtime)](art.md)** 로 완전히 교체되었다.
