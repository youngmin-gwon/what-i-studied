...
관련 노트: [APEX activation/rollback](apex-activation-and-rollback.md), [boot/runtime 정본](../boot-and-runtime/android-boot-and-runtime.md), [platform-modularity hub](android-platform-modularity.md).
