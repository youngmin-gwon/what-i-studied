...
관련 노트: [compile/runtime check](sdk-extension-compile-sdk-extension-and-runtime-check-are-separate-steps.md), [앱 availability check](apps-should-check-api-feature-availability-not-mainline-package-names.md).
