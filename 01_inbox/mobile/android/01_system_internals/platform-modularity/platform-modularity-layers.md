---
title: platform-modularity-layers
...
관련 노트: [Mainline 경계](project-mainline-updates.md), [Treble 정본](../kernel-and-hal/hal-native/project-treble-hal.md), [GKI 정본](../kernel-and-hal/kernel/generic-kernel-image.md).
