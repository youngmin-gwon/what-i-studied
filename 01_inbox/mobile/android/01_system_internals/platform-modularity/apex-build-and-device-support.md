---
title: apex-build-and-device-support
...
관련 노트: [APEX activation은 boot-time mount, version selection, rollback 경계다](apex-activation-and-rollback.md), [APEX는 APK 모델로 다루기 어려운 lower-level system module을 담는다](apex-module-packaging.md), [android-platform-modularity hub](android-platform-modularity.md).
