---
title: apex-activation-and-rollback
...
관련 노트: [APEX package 경계](apex-module-packaging.md), [boot/runtime 정본](../boot-and-runtime/android-boot-and-runtime.md), [platform-modularity hub](android-platform-modularity.md).
