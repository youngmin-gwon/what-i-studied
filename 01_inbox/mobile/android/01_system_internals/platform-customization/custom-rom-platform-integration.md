---
title: custom-rom-platform-integration
...
관련 노트: [Device bring-up은 board, kernel, HAL, VINTF, sepolicy 통합이다](device-bringup-integration.md), [GMS는 AOSP가 아니라 라이선스된 Google services layer다](gms-google-mobile-services.md), [platform signing과 release key는 update와 privilege boundary를 정의한다](platform-signing-keys.md).
