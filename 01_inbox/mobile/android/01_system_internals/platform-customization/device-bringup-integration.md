---
title: device-bringup-integration
...
관련 노트: [VINTF는 framework/vendor 호환성을 선언한다](../kernel-and-hal/hal-native/vintf-manifest-compatibility.md), [GKI는 공통 core kernel과 vendor module을 분리한다](../kernel-and-hal/kernel/generic-kernel-image.md), [platform debugging은 build, boot, service, VINTF, sepolicy, CTS를 분리한다](platform-debugging-framework.md).
