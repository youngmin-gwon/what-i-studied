---
title: platform-compatibility-tests-validate-device-not-app-features
...
관련 노트: [Platform debugging은 build, boot, service, VINTF, sepolicy, CTS를 분리한다](platform-debugging-separates-build-boot-service-vintf-sepolicy-and-cts.md), [Testing and quality contracts](../../../06_testing_performance/testing/testing-quality/testing-quality.md).
