---
title: platform-debugging-framework
...
- IPC 디버깅(Binder service 등록, call path)은 [IPC 디버깅은 service 등록, call path, thread state에서 시작한다](../ipc-and-process/ipc-service-debugging.md)가 다룬다.
