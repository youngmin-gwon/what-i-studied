...
date modified: 2026-08-03 17:26:32 +09:00
...
- 부팅 전 문제는 bootloader, kernel log, pstore, init log 부터 본다.
- service 문제는 `init.svc.*`, `service list`, `dumpsys`, Binder thread state 를 확인한다.
- HAL 문제는 VINTF manifest, service registration, SELinux denial, tombstone 을 함께 본다.
- CTS/VTS/GTS 실패는 테스트 이름보다 contract layer 를 먼저 분류한다.
