...
- IPC 디버깅(Binder service 등록, call path)은 [IPC 디버깅은 service 등록, call path, thread state에서 시작한다](../../ipc-and-process/ipc-process-contracts/ipc-debugging-starts-from-service-registration-call-path-and-thread-state.md)가 다룬다.
...
- [IPC 디버깅은 service 등록, call path, thread state에서 시작한다](../../ipc-and-process/ipc-process-contracts/ipc-debugging-starts-from-service-registration-call-path-and-thread-state.md)
