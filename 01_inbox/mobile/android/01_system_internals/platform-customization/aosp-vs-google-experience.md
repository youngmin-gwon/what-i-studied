---
title: aosp-vs-google-experience
...
- GMS 라이선스와 인증 요건은 [GMS는 AOSP가 아니라 라이선스된 Google services layer다](gms-google-mobile-services.md) 가 다룬다.
...
- [GMS는 AOSP가 아니라 라이선스된 Google services layer다](gms-google-mobile-services.md)
