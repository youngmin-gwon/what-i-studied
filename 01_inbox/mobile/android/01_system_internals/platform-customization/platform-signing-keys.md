...
관련 노트: [AVB는 부팅 이미지의 신뢰와 rollback 방지를 검증한다](../boot-and-runtime/boot-flow/android-verified-boot.md), [Android security and privacy](../../05_security_privacy/android-security-and-privacy.md)
