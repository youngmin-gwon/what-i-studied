---
title: partition-customization-ownership
...
관련 노트: [Android 플랫폼 모듈화는 system, vendor, kernel 업데이트 경계를 층위별로 나눈다](../platform-modularity/platform-modularity-layers.md)
