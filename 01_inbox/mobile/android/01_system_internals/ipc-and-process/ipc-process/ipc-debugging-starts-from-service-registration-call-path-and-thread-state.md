...
관련 노트: [dumpsys는 system service 상태 검사 인터페이스다](../../boot-and-runtime/system-server/dumpsys-is-system-service-state-inspection-interface.md), [Native service debugging은 init, Binder, VINTF, SELinux, tombstone을 분리한다](../../kernel-and-hal/hal-native/native-service-debugging-separates-init-binder-vintf-selinux-and-tombstones.md)
