...
앱 개발자가 이 구조를 알아야 하는 이유는 버그와 제약이 API boundary 하나에서 끝나지 않기 때문이다. 예를 들어 camera feature는 permission, app component, CameraX/Camera2, media pipeline, HAL, vendor implementation을 지나간다.
