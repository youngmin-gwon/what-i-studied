...
aliases: []
date modified: 2026-08-03 17:22:49 +09:00
date created: 2026-08-03 16:59:22 +09:00
---

## Foundation Contracts 는 안드로이드 플랫폼을 관통하는 근본적인 원칙과 계약이다

이 하위 지도는 system map 을 구성하는 판단 단위를 관리한다. 처음 읽을 때는 플랫폼 모형 → 진단 기준 → 구체 경로 순서로 진행한다.
...
새 노트가 여러 계층을 잇는 재사용 가능한 분류 기준이면 이 묶음에 둔다. 특정 subsystem 만 설명하면 해당 canonical area 에 둔다.
