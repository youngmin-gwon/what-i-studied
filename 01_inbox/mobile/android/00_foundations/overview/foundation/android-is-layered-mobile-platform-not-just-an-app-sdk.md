...
5. **Hardware Abstraction Layer ([HAL](../../../01_system_internals/kernel-and-hal/hal-native/hal.md))**:
...
3. **[`HAL`](../../../01_system_internals/kernel-and-hal/hal-native/hal.md) Level**: `CameraService`가 AIDL/HIDL 인터페이스를 통해 제조사의 `Camera HAL` 세션을 오픈.
...
- `CameraAccessException` 발생 시 ➔ **3 단계 하드웨어 점유 영역**: `CameraService` 또는 [`HAL`](../../../01_system_internals/kernel-and-hal/hal-native/hal.md) 상태 확인
...
| 특정 기기에서만 센서/하드웨어 경로 실패 | Service/[`HAL`](../../../01_system_internals/kernel-and-hal/hal-native/hal.md) error 로그, [`Linux Kernel`](../../../../../operating-systems/linux-kernel.md) dmesg | [`Linux Kernel`](../../../../../operating-systems/linux-kernel.md) / [`HAL`](../../../01_system_internals/kernel-and-hal/hal-native/hal.md) |
...
- [HAL 레퍼런스](../../../01_system_internals/kernel-and-hal/hal-native/hal.md) - 안드로이드 하드웨어 추상화 계층 레퍼런스
