...
- **Kotlin-First 전환**: 람다, Null-safety 및 [Kotlin Coroutines](../../02_app_framework/async-flow/coroutines/kotlin-coroutines.md) 기반 [StateFlow & SharedFlow](../../02_app_framework/async-flow/flow-state/stateflow-and-sharedflow.md) 비동기 수용.
