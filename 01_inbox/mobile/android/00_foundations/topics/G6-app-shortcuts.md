...
- [Static, dynamic, and pinned shortcuts have different ownership and lifecycle](../../04_system_services/device-capabilities/app-shortcuts/shortcut-ownership-lifecycles.md)
...
- [ShortcutManager caps dynamic shortcut count and rate limits background updates](../../04_system_services/device-capabilities/app-shortcuts/shortcut-manager-rate-limits.md)
