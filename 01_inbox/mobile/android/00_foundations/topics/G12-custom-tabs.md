...
- [Custom Tabs는 앱 WebView 프로세스가 아닌 브라우저 신뢰 경계를 공유함](../../02_app_framework/navigation/custom-tabs/custom-tabs-trust-boundary.md): WebView가 앱 내부에 격리된 샌드박스라면, Custom Tabs는 시스템 브라우저의 엔진과 세션을 그대로 활용하여 보안 인증과 사용자 경험을 향상시킨다는 차이를 설명합니다.
