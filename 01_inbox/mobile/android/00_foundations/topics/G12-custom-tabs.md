...
## Custom Tabs와 브라우저 통합 탐색

이 문서는 앱 내부에서 안전하게 웹 컨텐츠를 렌더링하면서 사용자의 브라우저 세션(쿠키, 자동완성)을 공유할 수 있도록 지원하는 Custom Tabs의 동작 원리와 WebView와의 차이점을 종합합니다.
...
Custom Tabs는 앱의 프로세스를 벗어나 기본 브라우저의 신뢰 경계 안에서 웹 페이지를 띄웁니다. 이를 통해 비밀번호 자동 완성, 로그인 세션 공유 등 브라우저 고유의 보안과 편의성을 앱 내부 경험처럼 제공할 수 있습니다.
