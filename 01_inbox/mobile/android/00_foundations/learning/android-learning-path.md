...
aliases: []
date modified: 2026-08-06 18:41:13 +09:00
...
1. [Android는 계층형 플랫폼이다](../overview/foundation/android-is-layered-mobile-platform-not-just-an-app-sdk.md)
2. [문제 boundary를 찾는다](../overview/foundation/android-stack-boundaries-explain-where-a-problem-belongs.md)
...
- Flutter 에서 넘어왔다면 1, 2 뒤에 개념 경계 매핑을 먼저 읽고 Context, [viewmodel](../../02_app_framework/architecture/state-management/viewmodel.md), Compose state 를 각각 비교한다.
