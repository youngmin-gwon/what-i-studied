...
상위 [Android Learning Path](01_inbox/mobile/android/00_foundations/learning/android-learning-path.md) 는 독자 배경과 문제별 navigation 을 소유하고, 이 지도는 학습 원칙의 역할 차이만 소유한다.
