...
관련 노트: [app architecture](../../../02_app_framework/architecture/android-app-architecture.md), [persistence](../../../02_app_framework/data/storage/persistence.md), [background work](../../../04_system_services/background-and-notifications/background-work.md), [performance](../../../06_testing_performance/performance/performance.md), [packaging/deployment](../../../03_packaging_deployment/android-packaging-deployment.md).
