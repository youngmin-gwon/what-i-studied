...
그 뒤에 Compose, [viewmodel](../../../02_app_framework/architecture/state-management/viewmodel.md), Flow, Room, WorkManager, Navigation, Hilt 같은 도구를 각 boundary 에 배치한다. 이 순서가 잡히면 새 API 가 나와도 어디에 넣어야 하는지 판단하기 쉽다.
