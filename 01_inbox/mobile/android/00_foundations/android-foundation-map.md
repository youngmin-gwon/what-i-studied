...
5. 낯선 약어는 [Android Glossary](../04_system_services/service-lookup/activity-manager-service.md) 에서 뜻만 확인하고 연결된 정본으로 이동한다.
...
- [Android Glossary](../04_system_services/service-lookup/activity-manager-service.md) - 용어의 짧은 정의와 정본 링크.
...
- [android-performance-quality-and-build-optimization.md](../06_testing_performance/android-performance-testing-map.md)
