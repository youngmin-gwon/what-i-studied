...
| 요구의 핵심                                                 | 먼저 읽을 계약                                                                                                                                                                     |
| ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 지연·재시도를 허용하며 앱/기기 재시작 뒤에도 예약을 복구                       | [WorkManager](./work-manager-contract.md)    |
...
| 진행 중임을 사용자가 계속 알아야 하고 허용된 foreground service type 에 해당 | [foreground service](./foreground-service-contract.md) |
| 특정 시각에 깨우는 행위 자체가 사용자 기능                               | [AlarmManager](./alarm-manager-contract.md)              |
...
| Worker 가 실행되지 않음 | `WorkInfo`, `dumpsys jobscheduler` 의 unsatisfied constraint·quota | [WorkManager](./work-manager-contract.md) |
