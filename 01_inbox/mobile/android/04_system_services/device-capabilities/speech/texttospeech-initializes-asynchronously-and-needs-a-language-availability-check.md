...
- 음성을 텍스트로 바꾸는 반대 방향 계약은 [SpeechRecognizer는 RECORD_AUDIO 권한을 전제로 하는 콜백 기반 비동기 계약이다](./speechrecognizer-is-a-callback-based-gated-by-record-audio-permission.md)가 다룬다.
