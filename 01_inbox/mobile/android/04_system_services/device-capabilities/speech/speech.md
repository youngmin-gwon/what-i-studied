...
- Assistant 질의를 앱 fulfillment로 연결하는 의미 해석과 실행 책임은 [Assistant와 에이전트 통합 계약](../../assistant-agent/assistant-agent.md)이 담당하며, 이 지도는 그 위에서 쓰이는 순수 음성 합성/인식 API 계약만 다룬다.
