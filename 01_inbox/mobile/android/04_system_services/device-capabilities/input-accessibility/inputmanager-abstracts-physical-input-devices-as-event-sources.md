...
- 텍스트 입력을 위한 소프트 키보드 자체의 계약은 [InputMethodService는 AccessibilityService와 다른 별도의 입력 계약이다](./inputmethodservice-is-a-separate-service-from-accessibilityservice.md)가 다룬다.
