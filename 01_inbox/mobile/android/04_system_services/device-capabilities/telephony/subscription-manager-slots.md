---
title: subscription-manager-slots
...
- 이 노트는 구독과 슬롯의 데이터 모델을 다룬다. 조회 자체의 permission 계층은 [TelephonyManager 권한은 READ_PHONE_STATE와 READ_PHONE_NUMBERS로 세분화된다](telephony-manager-permissions.md)가 다룬다.
