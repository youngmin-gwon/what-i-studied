...
- 이 노트는 세 종류의 소유권/lifecycle 차이까지만 다룬다. 개수 상한과 rate limit은 [ShortcutManager는 동적 shortcut 개수를 제한하고 백그라운드 갱신에 rate limit을 건다](./shortcutmanager-caps-dynamic-shortcut-count-and-rate-limits-background-updates.md)가 다룬다.
