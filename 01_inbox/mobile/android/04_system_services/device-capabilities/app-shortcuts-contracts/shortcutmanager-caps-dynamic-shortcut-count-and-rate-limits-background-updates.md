...
관련 지도: [App Shortcuts 접근 계약](./app-shortcuts-contracts.md)
...
- 이 노트는 개수/rate limit 계약까지만 다룬다. static/dynamic/pinned의 소유권과 lifecycle 차이는 [static/dynamic/pinned shortcut은 소유권과 lifecycle이 다르다](./static-dynamic-and-pinned-shortcuts-have-different-ownership-and-lifecycle.md)가 다룬다.
