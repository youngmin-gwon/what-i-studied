---
title: "CredentialManager는 비밀번호/패스키/연동 로그인을 하나의 API로 통합한다"
...
- 이 노트는 로그인 자격 증명 통합 API까지 다룬다. 생체 인증 자체의 UI/키 결합 메커니즘은 [BiometricPrompt는 인증 UI와 키 사용 승인을 함께 처리한다](01_inbox/mobile/android/04_system_services/device-capabilities/biometrics-credential-contracts/biometricprompt-couples-authentication-ui-with-key-authorization.md)가 다룬다.
