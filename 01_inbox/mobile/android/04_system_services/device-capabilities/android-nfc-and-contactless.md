...
tags: []
aliases: []
date modified: 2026-04-05 17:43:29 +09:00
date created: 2026-04-04 00:37:32 +09:00
---
...
안드로이드의 비접촉 결제 표준인 **HCE (Host-based Card Emulation)** 기술과 Android 16 에서 강화된 **NFC Forum 2026** 표준 대응 방안을 분석합니다.
...
안드로이드는 초기부터 NFC 를 개방적으로 운영하며 HCE 를 통해 독자적인 지갑 앱 구축을 지원해 왔습니다. 최근 플랫폼의 변화는 더 빠른 전송 속도와 시스템 수준의 통합 비접촉 결제 앱 설정을 통한 사용자 선택권 강화에 집중하고 있습니다. [[android-app-components-deep-dive]] 의 Service 구조 위에서 동작합니다.

>[!NOTE] **상호 참조**
>iOS 의 NFC 및 비접촉 결제 지원 방식은 [[apple-nfc-and-contactless]] 를 참고하세요.
...
- [[android-security-sandbox]] - NFC 통신 보안
