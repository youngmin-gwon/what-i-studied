...
- 텍스트를 음성으로 바꾸는 반대 방향 계약은 [TextToSpeech는 비동기로 초기화되며 사용 전 언어 가용성을 확인해야 한다](./texttospeech-initializes-asynchronously-and-needs-a-language-availability-check.md)가 다룬다.
