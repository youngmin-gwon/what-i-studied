...
관련 지도: [음성 합성/인식 접근 계약](./speech-contracts.md)
...
- 음성을 텍스트로 바꾸는 반대 방향 계약은 [SpeechRecognizer는 RECORD_AUDIO 권한을 전제로 하는 콜백 기반 비동기 계약이다](./speechrecognizer-is-a-callback-based-contract-gated-by-record-audio-permission.md)가 다룬다.
