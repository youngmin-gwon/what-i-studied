---
title: biometric-prompt-key-auth
...
- 이 노트는 인증 UI와 키 승인의 결합 메커니즘까지 다룬다. 프롬프트를 띄우기 전에 확인해야 하는 기기 지원 여부는 [BiometricManager.canAuthenticate는 실행 전에 확인해야 하는 사전 조건이다](biometric-manager-preconditions.md)가 다룬다.
