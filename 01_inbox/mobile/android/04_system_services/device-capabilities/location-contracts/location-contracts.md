...
- permission 은 접근 자격을, [AppOps](../../service-lookup/service-lookup-contracts/service-lookup-contracts.md) 는 실행 시점 허용을 답한다. 위치는 사용자가 세부 화면에서 앱별로 자주 재조정하는 대표적인 영역이다.
