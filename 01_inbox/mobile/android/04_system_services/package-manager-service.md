...
- [system_server](system-server.md) - PMS가 상주하여 실행되는 안드로이드 메인 시스템 프로세스
...
- [안드로이드 권한 시스템 & AppOps](../05_security_privacy/appops-and-permissions.md) - PMS가 관리하는 런타임 권한 승인 메커니즘
