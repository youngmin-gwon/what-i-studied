...
- [Macrobenchmark의 컴파일 모드는 테스트 계약의 일부다](./macrobenchmark-compilation-mode-is-part-of-test.md)
...
관련 지도: [Android 성능, 품질, 빌드 최적화 지도](../android-performance-quality-and-build-optimization.md), [런타임 성능 계약](../performance/performance.md), [테스트 품질 계약](../../testing/testing-quality/testing-quality.md)
