---
title: baseline-profile-generation-records-critical-user-journeys
...
관련 노트: [Android 성능은 측정 후 최적화한다](../performance/measure-before-optimizing-android-performance.md)
