---
title: memory-performance-leak-evidence
...
- **LeakCanary 누수 탐지 원리**:
  - 파괴된 Activity/Fragment/View와 cleared [viewmodel](../../02_app_framework/architecture/state-management/viewmodel.md) 등 더 이상 필요하지 않은 객체를 `ObjectWatcher`가 weak reference로 감시한다.
