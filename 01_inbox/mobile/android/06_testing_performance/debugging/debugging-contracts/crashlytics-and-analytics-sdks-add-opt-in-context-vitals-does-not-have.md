---
title: crashlytics-and-analytics-sdks-add-opt-in-context-vitals-does-not-have
...
상위 문서: [디버깅 도구 계약](./debugging-contracts.md)
...
- logcat/ANR trace 같은 로컬 진단 도구와의 역할 구분은 [Logcat, crash, ANR, debugger는 서로 다른 질문에 답한다](./logcat-crash-anr-and-debugger-answer-different-questions.md)가 다룬다.
