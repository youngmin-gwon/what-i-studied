...
- [Runtime permission은 사용자에게 기능 사용 시점에 요청하는 접근 계약이다](runtime-permission-is-user-mediated-access.md)
...
관련 지도: [Android 플랫폼 보안 경계 계약](../../platform-hardening/platform-security/platform-security.md)
