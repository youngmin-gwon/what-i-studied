...
tags: [android, android/security, android/storage, encryption]
aliases: [FBE, Scoped Storage, 안드로이드 저장소 보안]
date modified: 2026-04-05 17:43:39 +09:00
...
모든 앱이 공유 저장소(`SDCard`) 전체를 읽던 구 시대적 방식에서 탈피하여, 앱은 자신의 샌드박스 폴더 외에는 명시적 사용자 승인이나 API 를 통해서만 접근 가능하도록 제한되었다.
