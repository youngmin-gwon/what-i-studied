---
title: keystore-key-non-exportability
...
상위 문서: [보안 저장소 계약](secure-storage.md)

관련 노트: [BiometricPrompt는 Keystore 키 사용을 인가한다](biometric-prompt-keystore-auth.md), [AES-GCM은 고유한 IV와 Authentication Tag를 요구한다](aes-gcm-encryption-iv.md)
