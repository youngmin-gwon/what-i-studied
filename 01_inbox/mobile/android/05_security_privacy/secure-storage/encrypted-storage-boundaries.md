---
title: encrypted-storage-boundaries
...
관련 노트: [Android Keystore는 추출 불가능성으로 키를 보호한다](keystore-key-non-exportability.md), [AES-GCM은 고유한 IV와 Authentication Tag를 요구한다](aes-gcm-encryption-iv.md)
