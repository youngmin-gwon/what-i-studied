...
3. **Cache Eviction Guarantee**: `cacheDir` 및 `codeCacheDir`에 저장된 파일은 OS에 의해 언제든지 자동 삭제될 수 있으며 SSOT([single source of truth](../../../02_app_framework/single-source-of-truth.md))로 다루어질 수 없다.
