...
관련 노트: [Play Integrity token은 서버가 검증하는 위험 신호이지 권한 자체가 아니다](../../integrity-and-attestation/integrity/play-integrity-token-is-server-verified-risk-signal-not-authorization.md)
