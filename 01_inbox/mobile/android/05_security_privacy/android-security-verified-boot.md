...
tags: [android, android/security, dm-verity, verified-boot]
aliases: [AVB, Verified Boot, 부팅 무결성]
date modified: 2026-04-05 17:43:41 +09:00
...
Verified Boot 는 하드웨어 수준에서 소프트웨어의 무결성을 바통 터치(Chain of Trust) 방식으로 검증하여, 변조되지 않은 시스템 소스만 실행됨을 보장한다.
