...
2. **Binder 통신 전달**: 요청이 [Binder IPC](../../01_system_internals/ipc-and-process/binder-ipc.md)를 통해 [system-server](../../01_system_internals/boot-and-runtime/system-server/system-server.md) 내부의 해당 서비스(예: `LocationManagerService`)로 전달됩니다.
