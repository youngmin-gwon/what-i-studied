...
tags: [android, security, compliance, tools, vulnerability]
aliases: [Android Security Engineering, Frida, Drozer, 법규 준수]
---
...
- **Frida**: 런타임에 JavaScript를 삽입하여 함수 호출을 가로채거나 변조(Hooking)하는 도구.
