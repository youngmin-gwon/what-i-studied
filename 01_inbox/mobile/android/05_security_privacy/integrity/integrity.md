...
- [Play Integrity token은 서버가 검증하는 위험 신호이지 권한 자체가 아니다](play-integrity-token-verification.md)
- [Verified Boot는 기기 소프트웨어의 chain of trust를 만든다](../platform-hardening/verified-boot-trust-chain.md)

관련 지도: [Android 플랫폼 보안 경계 계약](../platform-hardening/platform-security.md), [Android 보안 실무는 클라이언트 신뢰가 아니라 방어 계층 설계다](../platform-hardening/defense-in-depth-principles.md)
