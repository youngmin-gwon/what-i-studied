...
- **Passkeys (FIDO2)**: 비밀번호를 대체하는 차세대 인증 표준으로, iCloud Keychain을 통해 기기 간 동기화되며 생체 인증으로 보호됩니다.
...
- **iCloud Keychain Sync**: 사용자가 한 기기에서 생성한 패스키는 동일한 Apple ID를 사용하는 다른 기기에서도 안전하게 사용 가능합니다.
...
- [[cross-platform-mobile-vulnerability-check]] - 모바일 취약점 종합 진단 가이드
