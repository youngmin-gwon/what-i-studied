...
## [mobile-security](../../mobile-security.md) > [mobile-apple-foundation-security](mobile-apple-foundation-security.md)
...
1. [apple-sandbox-and-security](apple-sandbox-and-security.md): **Apple Sandbox & Security Diagnosis** - 샌드박스 메커니즘과 앱 무결성 진단.
2. [apple-security-sandbox](apple-security-sandbox.md): **App Sandbox & MAC Internals** - 리소스 접근 격리 및 커널 수준 제어의 상세 동작.
3. [apple-security-entitlements](apple-security-entitlements.md): **Code Signing & Entitlements** - 앱 무결성 및 시스템 기능 권한 증명.
4. [apple-security-app-attest](apple-security-app-attest.md): **App Attest & DeviceCheck** - 서버 측의 앱 무결성 및 기기 신뢰성 검증.
5. [apple-security-tcc-compliance](apple-security-tcc-compliance.md): **TCC & Legal Compliance** - 프라이버시 승인 시스템과 법적 준수 사항.
...
- [mobile-apple-secure-storage](mobile-apple-secure-storage.md) - **Keychain & Secure Enclave**를 이용한 데이터 보호.
