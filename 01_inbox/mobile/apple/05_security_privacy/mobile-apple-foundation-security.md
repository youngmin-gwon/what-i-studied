...
2024-2025년 기준 Apple의 최신 보안 기술입니다.

- [[apple-security-pq3]]: **PQ3 Protocol** - iMessage의 양자 내성 암호화.
- [[apple-security-pcc]]: **Private Cloud Compute** - Apple Intelligence를 위한 클라우드 AI 프라이버시 모델.
