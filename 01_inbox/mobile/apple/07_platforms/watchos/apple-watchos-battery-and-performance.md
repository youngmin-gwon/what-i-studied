...
aliases: []
date modified: 2026-04-06 18:20:03 +09:00
...
- 작은 배터리/메모리, 강한 백그라운드 제한. [Jetsam](../../00_foundations/apple-glossary.md) 이 자주 발생할 수 있다.
...
- SwiftUI 에서 복잡한 레이아웃/긴 리스트를 줄인다. 필요 시 `TimelineView`/`Canvas` 최적화.
