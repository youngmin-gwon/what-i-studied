...
aliases: []
date modified: 2026-04-03 18:56:22 +09:00
...
- iPhone 과 페어링된 경우가 많지만, 셀룰러/와이파이 단독도 가능.
...
### UI/UX
- SwiftUI 권장. 큰 텍스트, 단순 제스처. Digital Crown/Swipe 로 스크롤.
...
- Background Refresh/Push 를 적게 사용. 남용 시 제한.
- 오디오/블루투스/VoIP 등 필요한 모드만 사용.

### 네트워크/동기화
- WCSession 으로 iPhone 과 데이터 교환. Reachability 체크, 지연/재시도 정책.
- Cloud/서버 동기화는 짧게/압축해 전송, 가능하면 나중에 iPhone 이 처리.
