...
aliases: []
date modified: 2026-04-03 18:55:43 +09:00
...
### 파일/권한
- NSOpenPanel/NSSavePanel 로 사용자가 선택한 경로만 접근. 재접근은 보안 북마크 필요.
...
- NSDocument/NSWorkspace 로 문서 기반/파일 통합.
...
- Grand Central Dispatch QoS 로 백그라운드 작업을 분리, 메인 스레드 UI 유지.
- Metal/Accelerate 로 CPU 부하를 줄이고, App Nap/에너지 임팩트도 점검.
...
### 자동화/스크립트
- AppleScript/Shortcuts/Automator, LaunchAgent/Daemon 으로 작업 자동화.
- 샌드박스 앱은 Apple Event Entitlement 가 필요.

### 가상화/컨테이너
- Virtualization.framework 로 VM 생성. 하드웨어 가속/네트워크/디스크 공유 설정.
