...
>상세 비교는 [**android-app-actions-assistant**](../../android/04_system_services/agents-and-assistant/assistant-agent-contracts/app-actions-map-assistant-queries-to-app-fulfillment.md) 를 참고하세요.
