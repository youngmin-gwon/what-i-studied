...
aliases: []
date modified: 2026-04-06 18:11:02 +09:00
...
- 사진: 전체 라이브러리 vs 선택한 항목만. Photos picker 로 최소 권한 권장.
...
[apple-sandbox-and-security](../05_security_privacy/apple-sandbox-and-security.md), [apple-sandbox-and-security](../05_security_privacy/apple-sandbox-and-security.md), [apple-distribution-and-policies](../05_security_privacy/apple-distribution-and-policies.md), [apple-accessibility-and-internationalization](../02_ui_frameworks/apple-accessibility-and-internationalization.md).
