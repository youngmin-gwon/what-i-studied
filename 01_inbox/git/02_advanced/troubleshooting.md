...
tags: [fsck, git, recovery, reflog, reset, revert, troubleshooting]
aliases: [Git 복구, Git 트러블슈팅, 데이터 심폐소생술, 실수 해결기]
date modified: 2025-12-18 15:22:21 +09:00
date created: 2025-12-18 14:25:00 +09:00
---

## Git 트러블슈팅: 실수를 기회로 바꾸는 복구의 기술

Git 의 진가는 성공할 때가 아니라 **실수했을 때** 나타납니다. 모든 변경사항을 스냅샷으로 저장하는 Git 의 특성을 활용하면, 지워진 브랜치나 분실한 커밋도 99% 복구가 가능합니다.

---

### 🏢 실무 사례 (Disaster Recovery)

- **삭제된 브랜치 복구**: 중요한 로직이 담긴 브랜치를 실수로 삭제했을 때, 커밋 해시만 알면 1 초 만에 되살릴 수 있습니다.
