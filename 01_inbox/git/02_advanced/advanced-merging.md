...
tags: [advanced, conflict, git, merge, strategy]
aliases: [고급 머지 가이드, 머지 전략, 수동 충돌 해결]
date modified: 2025-12-18 15:22:05 +09:00
date created: 2025-12-18 17:10:00 +09:00
---

## Advanced Merging: 복잡한 병합의 과학과 기술

Git 의 자동 머지는 훌륭하지만, 거대한 프로젝트나 복잡한 히스토리에서는 자동 해결이 불가능한 상황이 발생합니다. 이 문서에서는 머지 전략의 종류와 수동으로 충돌을 해결하는 고급 기법을 다룹니다.
...
두 브랜치를 합칠 때 공통 조상(Common Ancestor)이 여러 개인 경우, 조상들끼리 먼저 머지하여 가상의 조상을 만든 후 최종 머지를 수행합니다. Git 의 기본 전략입니다.
