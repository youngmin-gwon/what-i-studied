...
tags: [git, security, gpg, signing, staging, interactive]
aliases: [Git 보안 및 상세 스테이징, 커밋 서명, 대화형 스테이징]
date modified: 2025-12-18 17:55:00 +09:00
...
2. Git에 키 등록: `git config --global user.signingkey <key_id>`
3. 자동 서명 활성화: `git config --global commit.gpgsign true`

### 사용 및 확인
- **태그 서명**: `git tag -s v1.5 -m 'my signed tag'`
- **서명 확인**: `git log --show-signature`. GitHub에서는 서명된 커밋 옆에 **Verified** 배지가 표시됩니다.
...
- [[02_advanced/reset-demystified|Reset 완벽 분석]] - Reset과 스테이징의 관계
