---
title: TCP/IP Illustrated Vol.1 - Ch.17 TCP Keepalive
...
**17장: TCP 킵얼라이브 (TCP Keepalive)**

이 장은 데이터가 흐르지 않는 유휴(Idle) 상태의 연결을 유지하거나 죽은 연결을 탐지하기 위한 TCP의 킵얼라이브 기능에 대해 다룹니다. (본문 내용이 소스에 부재하여 목차를 기반으로 주제만 나열합니다.)
