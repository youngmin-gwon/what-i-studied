...
- [Serializable](../mobile/android/01_system_internals/ipc-and-process/binder-ipc.md) - KSP 기반 kotlinx.serialization 이 런타임 직렬화를 대체하는 원리
- [Parcelable](../mobile/android/01_system_internals/ipc-and-process/binder-ipc.md) - `@Parcelize` 컴파일러 플러그인이 코드를 자동 생성하는 사례
