...
<details>
<summary>(작업형) HP-UX 운영체제에서 패스워드 보호를 강화하기 위해 시스템을 **Trust Mode로 전환(설정)**하는 명령어와, 필요한 경우 이를 다시 **일반 모드로 해제**하는 명령어를 각각 작성하시오. (단, 설정 파일 경로를 포함할 것)</summary>
<blockquote>
...
- 정 책: 계정: ( A ) 계정 이름 바꾸기<br>
- 보안 설정: admin_secure_win</summary>
<blockquote>
...
- ( A ) 속성<br>
- 설명: ( A ) have complete and unrestricted access to the computer/domain</summary>
<blockquote>
<strong>Administrators</strong>
</blockquote>
</details>
...
3) 다음 시간 후 계정 잠금 수를 원래대로 설정: ( C )분 이상</summary>
<blockquote>
...
- 다음 시간 후 계정 잠금 수를 원래대로 설정: 60분</summary>
<blockquote>
