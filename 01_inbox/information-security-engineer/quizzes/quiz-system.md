...
tags: []
aliases: []
date modified: 2026-03-24 16:50:00 +09:00
...
- 보안 로그: %SystemRoot%\System32\winevt\Logs\security.evtx<br><br>
※ <strong>evtx (Event Log Extended)란?</strong><br>
윈도우 비스타 및 윈도우 서버 2008부터 도입된 <strong>XML 기반의 바이너리 로그 형식</strong>입니다. 기존의 <code>evt</code> 포맷에 비해 검색/필터링 속도가 빠르고 데이터가 압축되어 저장되며, 이벤트 뷰어에서 정밀한 XML 쿼리를 통해 로그를 분석할 수 있는 차세대 이벤트 로그 표준입니다.
