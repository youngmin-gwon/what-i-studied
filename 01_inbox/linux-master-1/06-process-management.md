---
title: 06-process-management
tags: []
aliases: []
date modified: 2025-12-29 10:31:59 +09:00
date created: 2025-12-10 19:31:25 +09:00
---
...
- **load average**: 1 분, 5 분, 15 분 평균 부하
- **us**: 사용자 공간 CPU
- **sy**: 시스템(커널) CPU
- **ni**: nice 프로세스 CPU
- **id**: 유휴 CPU
...
#### 우선순위
- **nice**: -20 (높음) ~ 19 (낮음)
- **nice -n 10 command**: nice 10 으로 실행
