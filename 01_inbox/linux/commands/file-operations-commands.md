...
tags: [linux, commands, file-operations, filesystem]
aliases: [파일 명령어, File Commands, ls, cp, mv, find]
...
Linux에서 가장 자주 사용하는 파일 및 디렉토리 관련 명령어들입니다. 파일 탐색, 생성, 복사, 이동, 삭제, 검색, 권한 관리 등을 다룹니다.
