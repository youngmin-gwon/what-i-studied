---
title: 02-expansions
tags: [bash, expansion, linux, shell]
aliases: []
date modified: 2025-12-28 20:54:15 +09:00
date created: 2025-12-28 20:44:16 +09:00
---
...
| **6** | **프로세스 대체 (Process Substitution)** | `<(ls)`, `>(grep)` (Bash 전용) |
...
| 표현식 | 설명 (var 가 설정되지 않았거나 null 일 때) |
| :--- | :--- |
...
- **문법**: `$(( expression ))`
- **특징**: 정수 연산만 지원 (부동소수점 불가), 64 비트 정수 지원.
- **예시**: `n=$((n + 1))` 또는 `((n++))`
