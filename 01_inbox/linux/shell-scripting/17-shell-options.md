---
title: 17-shell-options
tags: [bash, linux, options, set, shell, shopt]
aliases: []
date modified: 2025-12-28 21:20:45 +09:00
date created: 2025-12-28 20:46:28 +09:00
---
...
| 옵션            |  숏컷  | 설명                      | 보완 및 주의사항                          |
| :------------ | :--: | :---------------------- | :--------------------------------- |
| **errexit**   | `-e` | 명령 실패 시 즉시 종료           | `if`, `while`, `for` 등 예외 구간 인지 필요 |
