...
date modified: 2025-12-10 00:14:43 +09:00
...
1. **IPv6 MTU**: IPv6 는 최소 **1280 바이트**의 패킷 크기를 요구합니다.
2. **802.15.4 MTU**: 하지만 저전력 무선 규격 (IEEE 802.15.4) 은 한 번에 최대 **127 바이트**만 보낼 수 있습니다.
