...
date modified: 2025-12-09 18:27:26 +09:00
...
> **상위 레벨의 "약속" vs 물리적인 "파이프"**

- **Matter (Application Layer)**: "전등을 켜라"는 명령문의 형식을 정의합니다. 내가 누구고 (Device Type), 무슨 기능이 있는지 (Cluster) 를 표준화합니다.
...
2. **Messaging**: **CoAP (Constrained Application Protocol)** 기반의 가벼운 메시징.
