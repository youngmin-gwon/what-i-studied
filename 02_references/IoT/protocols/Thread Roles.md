...
date modified: 2025-12-09 18:21:20 +09:00
date created: 2025-12-09 18:18:05 +09:00
---

## 🕸️ Thread 네트워크 주요 역할 (Roles)

Thread 네트워크를 구성하는 장치들의 물리적/논리적 역할입니다.

| 역할 (Role) | 설명 | 주요 특징 / 기능 |
| :--- | :--- | :--- |
| **Border Router** | **Thread ↔ IP 네트워크** 간 라우팅 역할 | - Thread(저전력) 와 Wi-Fi/이더넷 (고속) 네트워크 간의 **IP 브리지**<br>- 외부 인터넷 연결 또는 로컬망 내 다른 Matter 기기와의 통신 중계<br>- 예: HomePod mini, Nest Hub |
