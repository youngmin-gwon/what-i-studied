...
| **애플리케이션** | HTTP, [MQTT](../foundation/MQTT.md) 등 다양 | 없음 (Data Agnostic)  | [ZCL](../foundation/ZCL.md) (내장)    |
|            |                                          |                     |                                     |
...
| 프로토콜       | 주파수 대역      | 채널              | 비고                                                           |
| :--------- | :---------- | :-------------- | :----------------------------------------------------------- |
| **Thread** | 2.4 GHz     | 16 ch (5MHz 간격) | **[IEEE 802.15.4](../connectivity/IEEE_802_15_4/IEEE%20802.15.4.md)** 사용. [Zigbee](../connectivity/Zigbee.md) 와 동일.              |
| **BLE**    | 2.4 GHz     | 40 ch (2MHz 간격) | [Bluetooth](../connectivity/Bluetooth.md) PHY 사용. 서로 호환 안 됨. |
| **Wi-Fi**  | 2.4 / 5 GHz | 다양함             | 높은 출력, 넓은 대역폭.                                               |

>[!NOTE] 커미셔닝 (Commissioning) 과 BLE
>[Matter](../matter/Matter.md) 기기 설정 시 Thread 기기도 **BLE**를 사용하여 스마트폰과 처음 연결하는 경우가 많습니다. 하지만 이는 **선택 사항**입니다.
