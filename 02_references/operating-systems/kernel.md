...
date modified: 2025-12-17 11:49:55 +09:00
...
**XDP(eXpress Data Path)**는 eBPF 를 드라이버 레벨에서 실행해 패킷을 초고속으로 필터링한다 (DDoS 방어 등).
...
멀티 소켓 서버는 CPU 마다 로컬 메모리가 있다. 원격 메모리 접근은 로컬보다 2~3 배 느리다.
