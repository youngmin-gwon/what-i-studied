...
- 때로는, singleton 은 anti-pattern 이라는 것을 숙지해야함 (OOP [SOLID](../../../solid/SOLID.md) principle 에서 [SRP(Single Responsibility Principle)](../../../solid/SRP(Single%20Responsibility%20Principle).md) 을 위배함)
