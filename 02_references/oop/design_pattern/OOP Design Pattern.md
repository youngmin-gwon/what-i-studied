...
aliases: [oop]
date modified: 2025-12-09 12:02:29 +09:00
...
> 디자인 패턴은 대부분의 프로그래밍 상황에서 유용하게 사용하기 위해 공통적으로 사용 되는 디자인 패턴을 명명, 추상화, 명시화 한 것 이고, 이는 재사용 가능한 객체지향 디자인을 만들기 위함이다.
...
1. [Creational Pattern](creational/Creational%20Pattern.md)
2. [Structural Pattern](structural/Structural%20Pattern.md)
3. [Behavioral Pattern](behavioral/Behavioral%20Pattern.md)
