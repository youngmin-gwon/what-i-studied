...
aliases: []
date modified: 2026-07-23 14:49:32 +09:00
...
Client 사용 예는 아래처럼 체인의 첫 핸들러만 `Handler` 로 들고 호출함.

```kotlin
val chain: Handler = AuthHandler(
    next = CacheHandler(next = null, cache = cache),
