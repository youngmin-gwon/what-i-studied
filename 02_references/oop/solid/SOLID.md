...
tags: [oop, solid]
aliases: []
date modified: 2025-12-11 14:50:59 +09:00
...
- 객체에게 데이터를 요구하는 행위는 객체화를 손상시키는 행동일 수 있으니 다시 한번 생각해보자 ⇒ **데이터는 감춰라 (Information Hiding)**-** 들어가기 전에 알고 가야하는 것**- OOP 를 이야기할 때 빠질 수 없는 이야기 ⇒** 유지보수성**- 유지보수성 vs 성능
